...
|---|---|---|---|---|---|---|
| `ai_v12_10_ladder_vf15` | `--vf-coef 1.5` (v6 2026-09-11: class AUC t4–10 **−0.082 DETECTED DOWN**; the decodable part −0.068 — more value gradient REMOVED opponent information from the representation) | +0.0140 [−0.0080, +0.0389] | +0.0486 [−0.0305, +0.1311] | +0.1634 [−0.0807, +0.3733] | **NOT DETECTED** on all four; identity bias on ALL states +0.048 [+0.014, +0.082] MORE optimistic (vs ZERO, no floor) | `measurements/critic_ladder_reads/vf15_vs_ctrl10M_2026-09-08/` · ledger 2026-09-08 *READ · critic ladder arm 1* |
