...
| **arm 8 — `ai_v12_19_ladder_lambda09`, `--win-prob-lambda 0.9`** (pin `28ece02a`) | READ at 10M vs all three controls | +0.019 [−0.001, +0.035] (vs ctrl10M) | +0.032 WITHIN FLOOR | +0.046 WITHIN FLOOR | **CANDIDATE — own-team R² t1 +0.146 [+0.064, +0.228] / +0.148 [+0.069, +0.229] DETECTED vs the two 40/40/10 controls (arm ≈ 0.15, controls ≈ 0); bot resolution leans +0.01–0.02; opponent axis unmoved; late-pessimism watch item inside the floor; offline 400/800 reads + a replicate (seed 1002) queued** | `measurements/critic_ladder_reads/lambda09_vs_ctrl10M_2026-09-10/` · ledger 2026-09-10 *READ · arm 8* |
