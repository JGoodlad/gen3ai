...
| **`ai_v12_17_ladder_strata`** | `--win-prob-strata-weight 1.0` (realized bot share 0.473 vs 0.5) | +0.0052 [−0.0121, +0.0161] | −0.0153 [−0.0929, +0.0585] | −0.0047 [−0.2340, +0.1806] | NOT DETECTED on every row registered at the time. **v6 (2026-09-11), on the decision row declared before the read: class AUC t4–10 0.760 vs 0.710, Δ +0.050 [+0.036, +0.064], DETECTED past the 0.022 floor — the campaign's FIRST detection on a decision row; t1–3 +0.040 DETECTED; THREE draws: +0.050 / +0.033 / +0.044, two of three clearing the floor by CI; replicate `strata_b` TRAINING** | `measurements/critic_ladder_reads/strata_vs_ctrl10M_2026-09-09/` · ledger 2026-09-09 *READ · critic ladder arm 7* |
