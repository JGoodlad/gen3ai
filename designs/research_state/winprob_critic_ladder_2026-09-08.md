...
| `ai_v12_12_ladder_cflabels` | `--cf-records --cf-winprob-coef 0.5` (+ `--checkpoint-every-steps 500000`) | +0.0054 [−0.0121, +0.0191] | +0.0380 [−0.0382, +0.1122] | +0.1928 [−0.0549, +0.4084] | resolution/late/clock NOT DETECTED; **own-team R² t1 Δ +0.084 [+0.032, +0.183] DETECTED (vs zero; matched-quota re-read pending)**; spread ratio t1–3 Δ −0.115 n.d.; head unbiased vs its continuation (Δ +0.040 [+0.007, +0.071]) | `measurements/critic_ladder_reads/cflabels_vs_ctrl10M_2026-09-09/` · ledger 2026-09-09 *READ · critic ladder arm cflabels* |
