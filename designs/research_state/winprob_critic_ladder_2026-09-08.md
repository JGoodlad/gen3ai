...
| is the row a head or a representation quantity? | **both move together** (branch A) — `strata` +0.048/+0.064 and `vf15` −0.052/−0.045 on `value_pooled → class`, same signs as V; the V row stays the decision row (cheaper, tighter floor) | `measurements/repr_class_decode_2026-09-11/` |
