...
|---|---|---|
| does any lever move the decision row `cond.opp_class_auc.t4_10`? | **no confirmed one.** `strata` +0.050 (n = 1) → replicate −0.03: NOT CONFIRMED; `vf15` −0.082 DOWN at n = 1, replicate `vf15_b` launched; every other lever within the 0.022 floor | ledger 2026-09-12 *VERDICT · strata_b FAILS* |
