...
# THE 16 TAUGHT TEAMS — resolved from each arm's OWN recorded --distill-teacher, whose ':*' expands
# to each teacher's recorded --trainee-teams. Verified 2026-09-04: all four TC arms resolve to this
# identical set, it is DISJOINT from the untaught 8, and every file exists. Never hand-type it.
SLICES = [
    ("T_009e3d02", "data/teams/sample/009e3d0244.txt"),
    ("T_37d717a9", "data/teams/sample/37d717a93a.txt"),
    ("T_43633560", "data/teams/sample/436335607f.txt"),
    ("T_64a691c4", "data/teams/sample/64a691c473.txt"),
    ("T_6916e138", "data/teams/sample/6916e13879.txt"),
    ("T_6ebe9ebc", "data/teams/sample/6ebe9ebc4d.txt"),
    ("T_750d0561", "data/teams/sample/750d056194.txt"),
    ("T_8bdb5796", "data/teams/sample/8bdb5796b9.txt"),
    ("T_9b454d9e", "data/teams/sample/9b454d9ea7.txt"),
    ("T_9d8391d8", "data/teams/sample/9d8391d864.txt"),
    ("T_9e95fb59", "data/teams/sample/9e95fb59d7.txt"),
    ("T_a9831a5f", "data/teams/sample/a9831a5f5e.txt"),
    ("T_aea50f20", "data/teams/sample/aea50f207e.txt"),
    ("T_b904dbe0", "data/teams/sample/b904dbe059.txt"),
    ("T_e2806956", "data/teams/sample/e28069562f.txt"),
    ("T_e702a104", "data/teams/sample/e702a104eb.txt"),
]
# A seed family of its own. The untaught probe carries TWO _SEED_BASE assignments (90 then 9, the
# second shadowing the first) — left alone deliberately: every untaught measurement on record used
# the effective value, so "fixing" it would silently reseed the standing meter and break
# comparability with the whole existing series.
_SEED_BASE = 40
