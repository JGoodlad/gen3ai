#!/usr/bin/env bash
# LAUNCH — B2, ai_v13_27_popr2_loop: population-loop ROUND 2 (orchestrator spec 2026-09-24, branch N+ of record a6637f29).
# Round 1's argv_B.txt with ONLY --run-name, --model (ai_v13_22_popr1_loop @103,219,200), --steps 111219200
# (= parent final + 8,000,000, a TOTAL) and RB added to --stable-opponents changed. Pin 6eb9c776, seed 1001.
ARM=B2
RUN=ai_v13_27_popr2_loop
ARGV_FILE=/home/goodlad/.claude/jobs/popr2_2026-09-24/argv_B2.txt
LOG_DIR=/home/goodlad/.claude/jobs/popr2_2026-09-24/launch
PREREQ_ZIPS=(models/ai_v13_22_popr1_loop/final_model.zip
...
"  - 🌱 [SELFPLAY] [pool] seeded 20 snapshots + metadata from ai_v13_22_popr1_loop"
"  - 🐴 [STABLE] 3 cross-run opponent(s): ext_ai_v13_18_teach5_offense_hidose, ext_ai_v13_13_exploit5_offense,"
"    ext_ai_v13_24_popr1_read_loop — each [pilots ITS OWN pin: 9eb3abdc52876a63.txt]; training ≤40% of self-play"
...
"  - after the FIRST eval: tb train/stable_fraction = 0.36; eval rows carry all THREE ext_ opponents"
)
