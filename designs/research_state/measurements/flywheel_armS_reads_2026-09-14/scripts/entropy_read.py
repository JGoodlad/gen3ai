#!/usr/bin/env python3
"""ARM S run-end POLICY-ENTROPY read (registration sec 8.3).
...
`--ent-coef` is LIVE on a resume (model_build.py:543), unlike `--lr`, so 0.05 holds for arm S's
whole run and the series is one regime in the coefficient.
"""
