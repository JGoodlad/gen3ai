...
The critic ladder's registered read (ledger 2026-09-08 *REGISTRATION · THE CRITIC LADDER*), produced by `python -m main.ops.critic_read` v2 at 2026-09-09T05:15:21. Every number is a DELTA, **arm − control**, with the difference of the two runs' independent battle-clustered bootstraps. Strength is NOT read.
...
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected · `turn 1-3` | +0.2515 | +0.1152 | **+0.1362** | [-0.3152, +0.4826] | **NOT DETECTED** (CI covers zero) |
| own-team leave-one-battle-out win-rate R^2 of V · `turn 1` | -0.0466 | -0.0237 | **-0.0229** | [-0.2312, +0.0917] | **NOT DETECTED** (CI covers zero) |
...
|---|---|---|---|---|---|---|---|
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected ⭐ | `turn 1-3` | +0.2515 | +0.1152 | **+0.1362** | [-0.3152, +0.4826] | 2000 | **NOT DETECTED** (CI covers zero) |
| the same ratio UNCORRECTED and unclamped | `turn 1-3` | +0.3942 | +0.3333 | **+0.0609** | [-0.2650, +0.3167] | 2000 | **NOT DETECTED** (CI covers zero) |
| sd(V) - sd(outcome), noise-corrected | `turn 1-3` | -0.0389 | -0.0886 | **+0.0497** | [-0.0115, +0.0789] | 2000 | **NOT DETECTED** (CI covers zero) |
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected | `all states` | +0.5345 | +0.7895 | **-0.2549** | [-0.6704, +0.4634] | 2000 | **NOT DETECTED** (CI covers zero) |
| the same ratio UNCORRECTED and unclamped | `all states` | +0.6293 | +0.8053 | **-0.1760** | [-0.5588, +0.3676] | 2000 | **NOT DETECTED** (CI covers zero) |
| sd(V) - sd(outcome), noise-corrected | `all states` | -0.0242 | -0.0211 | **-0.0031** | [-0.0463, +0.0440] | 2000 | **NOT DETECTED** (CI covers zero) |
| slope of bias (V - true win rate) on opponent Elo, per 100 Elo | `all states` | +0.0142 | +0.0098 | **+0.0044** | [-0.0090, +0.0168] | 2000 | **NOT DETECTED** (CI covers zero) |
| own-team leave-one-battle-out win-rate R^2 of V ⭐ | `turn 1` | -0.0466 | -0.0237 | **-0.0229** | [-0.2312, +0.0917] | 2000 | **NOT DETECTED** (CI covers zero) |
| own-team leave-one-battle-out win-rate R^2 of V | `all states` | -0.0093 | -0.0098 | **+0.0005** | [-0.1135, +0.1285] | 2000 | **NOT DETECTED** (CI covers zero) |
| opponent-CLASS (pool vs bot) AUC of V | `turn 1` | +0.5963 | +0.4619 | **+0.1344** | [-0.0214, +0.2857] | 2000 | **NOT DETECTED** (CI covers zero) |
...
python -m main.ops.critic_read ai_v12_10_ladder_vf15 --control ai_v12_11_ladder_ctrl10M --step 10000032 --out /home/goodlad/.claude/jobs/9ab51de6/tmp/read_vf15_v2 --quiet
...
| this report | `/home/goodlad/.claude/jobs/9ab51de6/tmp/read_vf15_v2/critic_read.md` |
| machine-readable | `/home/goodlad/.claude/jobs/9ab51de6/tmp/read_vf15_v2/critic_read.json` |
