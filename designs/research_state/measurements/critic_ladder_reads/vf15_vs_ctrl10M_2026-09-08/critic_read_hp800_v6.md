...
The critic ladder's registered read (ledger 2026-09-08 *REGISTRATION · THE CRITIC LADDER*), produced by `python -m main.ops.critic_read` v6 at 2026-09-11T11:05:41. Every number is a DELTA, **arm − control**, with the difference of the two runs' independent battle-clustered bootstraps. Strength is NOT read.
...
|---|---|---|---|---|---|---|
| resolution · `bot` | — | +0.0238 | +0.0170 | **+0.0068** | [+0.0015, +0.0125] | **WITHIN FLOOR** (|delta| <= floor 0.0074) |
...
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected · `turn 1-3` | as traced | +0.1652 | +0.1454 | **+0.0198** | [-0.0151, +0.0574] | **WITHIN FLOOR** (|delta| <= floor 0.0533) |
| own-team leave-one-battle-out win-rate R^2 of V · `turn 1` | MATCHED 797/269/9 | +0.0732 | +0.0440 | **+0.0291** | [+0.0147, +0.0437] | **DETECTED** (CI clears the floor +0.0109) |
| calibration SLOPE — weighted logistic regression of the outcome on logit(V) (1 = correctly dispersed, >1 = SHRUNK, <1 = over-dispersed) · `all states, <=2 per battle` | as traced | +1.0174 | +1.0695 | **-0.0521** | [-0.1235, +0.0201] | **WITHIN FLOOR** (|delta| <= floor 0.1085) |
...
| resolution ⭐ | `bot` | `capture-rate (gauge)` | +0.0238 | +0.0170 | **+0.0068** | [+0.0015, +0.0125] | 400 | **WITHIN FLOOR** (|delta| <= floor 0.0074) |
| resolution ⭐ | `pool` | `capture-rate (gauge)` | +0.0565 | +0.0614 | **-0.0048** | [-0.0165, +0.0081] | 400 | **WITHIN FLOOR** (|delta| <= floor 0.0141) |
...
| ece | `all` | `capture-rate (gauge)` | +0.0145 | +0.0237 | **-0.0092** | [-0.0160, +0.0009] | 400 | **WITHIN FLOOR** (|delta| <= floor 0.0144) |
...
| Murphy reliability | `ALL` | `pop` | +0.0015 | +0.0030 | **-0.0015** | [-0.0051, +0.0016] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0022) |
| Murphy reliability ⭐ | `ALL` | `ipw` | +0.0015 | +0.0030 | **-0.0015** | [-0.0051, +0.0016] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0022) |
...
|---|---|---|---|---|---|---|---|---|
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected ⭐ | `turn 1-3` | as traced | +0.1652 | +0.1454 | **+0.0198** | [-0.0151, +0.0574] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.0533) |
| the same ratio UNCORRECTED and unclamped | `turn 1-3` | MATCHED 797/269/9 | +0.1681 | +0.1474 | **+0.0207** | [-0.0148, +0.0573] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.0535) |
| sd(V) - sd(outcome), noise-corrected | `turn 1-3` | as traced | -0.0661 | -0.1018 | **+0.0357** | [+0.0227, +0.0484] | 2000 | **DETECTED** (CI clears the floor +0.0071) |
...
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected | `turn 4-10` | as traced | +0.4104 | +0.5080 | **-0.0976** | [-0.1689, -0.0211] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.2179) |
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected | `turn 11-24` | as traced | +0.6539 | +0.7039 | **-0.0500** | [-0.1565, +0.0674] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.1920) |
| own-team leave-one-battle-out win-rate R^2 of V ⭐ | `turn 1` | MATCHED 797/269/9 | +0.0732 | +0.0440 | **+0.0291** | [+0.0147, +0.0437] | 2000 | **DETECTED** (CI clears the floor +0.0109) |
| own-team leave-one-battle-out win-rate R^2 of V | `all states` | MATCHED 797/269/9 | +0.0104 | +0.0108 | **-0.0004** | [-0.0058, +0.0050] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.0025) |
...
| opponent-CLASS (pool vs bot) AUC of V | `turn 1-3` | MATCHED 797/269/9 | +0.5576 | +0.5803 | **-0.0227** | [-0.0397, -0.0059] | 2000 | **NOT DETECTED** (CI does not clear the floor 0.0153) |
| opponent-CLASS (pool vs bot) AUC of V | `turn 4-10` | MATCHED 797/269/9 | +0.6278 | +0.7093 | **-0.0815** | [-0.0961, -0.0658] | 2000 | **DETECTED** (CI clears the floor +0.0219) |
| OPPONENT-DECODABLE between-opponent spread ratio — sum_o q(o|V)*p_o, noise-corrected (NOT a bound on the row above) | `turn 1-3` | MATCHED 797/269/9 | +0.0140 | +0.0178 | **-0.0038** | [-0.0070, -0.0008] | 2000 | **PROVISIONAL — no floor; never DETECTED** (a DESCRIPTIVE DECOMPOSITION TERM, never a pass/fail bar and never a treatment effect. It is the between-opponent spread ratio a head conditioning ONLY on WHICH OPPONENT its own `V` reveals would exhibit — `sum_o q(o|V)*p_o` — and it is read BESIDE `cond.spread_ratio.<window>` to split that row into an OPPONENT-IDENTITY part and a remainder. 🚨 IT IS NOT AN UPPER BOUND ON THAT ROW AND `V` ROUTINELY EXCEEDS IT: measured on the hp800 lambda09/ctrl10M pair, V reads 0.647 / 0.704 at turns 11-24 against this row's 0.214 / 0.187. A per-state conditional mean is an ATTENUATING transform, so the cell-mean spread of `E[p_o | V]` is smaller than the cell-mean spread of `V` itself; the excess is between-opponent spread that rides on BOARD STATE correlated with the opponent rather than on opponent identity. A delta between two sides is a difference in how much opponent IDENTITY each side's output carries; it is reported, and it is never DETECTED) |
| OPPONENT-DECODABLE between-opponent spread ratio — sum_o q(o|V)*p_o, noise-corrected (NOT a bound on the row above) | `turn 4-10` | MATCHED 797/269/9 | +0.0582 | +0.1262 | **-0.0680** | [-0.0814, -0.0558] | 2000 | **PROVISIONAL — no floor; never DETECTED** (a DESCRIPTIVE DECOMPOSITION TERM, never a pass/fail bar and never a treatment effect. It is the between-opponent spread ratio a head conditioning ONLY on WHICH OPPONENT its own `V` reveals would exhibit — `sum_o q(o|V)*p_o` — and it is read BESIDE `cond.spread_ratio.<window>` to split that row into an OPPONENT-IDENTITY part and a remainder. 🚨 IT IS NOT AN UPPER BOUND ON THAT ROW AND `V` ROUTINELY EXCEEDS IT: measured on the hp800 lambda09/ctrl10M pair, V reads 0.647 / 0.704 at turns 11-24 against this row's 0.214 / 0.187. A per-state conditional mean is an ATTENUATING transform, so the cell-mean spread of `E[p_o | V]` is smaller than the cell-mean spread of `V` itself; the excess is between-opponent spread that rides on BOARD STATE correlated with the opponent rather than on opponent identity. A delta between two sides is a difference in how much opponent IDENTITY each side's output carries; it is reported, and it is never DETECTED) |
| OPPONENT-DECODABLE between-opponent spread ratio — sum_o q(o|V)*p_o, noise-corrected (NOT a bound on the row above) | `turn 11-24` | MATCHED 797/269/9 | +0.0824 | +0.1868 | **-0.1044** | [-0.1240, -0.0858] | 2000 | **PROVISIONAL — no floor; never DETECTED** (a DESCRIPTIVE DECOMPOSITION TERM, never a pass/fail bar and never a treatment effect. It is the between-opponent spread ratio a head conditioning ONLY on WHICH OPPONENT its own `V` reveals would exhibit — `sum_o q(o|V)*p_o` — and it is read BESIDE `cond.spread_ratio.<window>` to split that row into an OPPONENT-IDENTITY part and a remainder. 🚨 IT IS NOT AN UPPER BOUND ON THAT ROW AND `V` ROUTINELY EXCEEDS IT: measured on the hp800 lambda09/ctrl10M pair, V reads 0.647 / 0.704 at turns 11-24 against this row's 0.214 / 0.187. A per-state conditional mean is an ATTENUATING transform, so the cell-mean spread of `E[p_o | V]` is smaller than the cell-mean spread of `V` itself; the excess is between-opponent spread that rides on BOARD STATE correlated with the opponent rather than on opponent identity. A delta between two sides is a difference in how much opponent IDENTITY each side's output carries; it is reported, and it is never DETECTED) |
| WITHIN-own-team Murphy resolution of V (cells >= MIN_TEAM_BATTLES battles, battle-weighted over teams) | `all states, <=2 per battle` | MATCHED 797/269/9 | +0.0489 | +0.0534 | **-0.0046** | [-0.0094, -0.0010] | 2000 | **NOT DETECTED** (CI does not clear the floor 0.0044) |
| the same resolution WITHIN team-STRENGTH strata (quantiles of the team's LOO win rate) | `all states, <=2 per battle` | MATCHED 797/269/9 | +0.0287 | +0.0308 | **-0.0021** | [-0.0056, +0.0014] | 2000 | **NOT DETECTED** (CI covers zero) |
| BETWEEN-team spread ratio sd(mean V) / sd(team win rate), noise-corrected | `turn 1-3` | MATCHED 797/269/9 | +1.3840 | +1.2187 | **+0.1653** | [-0.0989, +0.1378] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.4324) |
| the same ratio UNCORRECTED and unclamped | `turn 1-3` | MATCHED 797/269/9 | +0.6812 | +0.6645 | **+0.0167** | [-0.0511, +0.0538] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.2507) |
| own-team leave-one-battle-out win-rate R^2 of V | `turn >= 25` | MATCHED 797/269/9 | +0.0026 | +0.0043 | **-0.0017** | [-0.0083, +0.0048] | 2000 | **NOT DETECTED** (CI covers zero) |
| own-team R^2 at turn 1 MINUS own-team R^2 late | `turn 1 - turn >= 25` | MATCHED 797/269/9 | +0.0706 | +0.0395 | **+0.0311** | [+0.0163, +0.0468] | 2000 | **PROVISIONAL — no floor; never DETECTED** (NO FLOOR EXISTS FOR THIS ROW AND THE CONTROLS CANNOT SUPPLY ONE — every control reads own-team R^2 ~= 0 at turn 1, so there is nothing for it to FALL from and the two-draw replicate floor cannot be formed. The first replicate arm supplies it. A LARGE move either way is informative; a small one is not; and this row is never DETECTED) |
| calibration SLOPE — weighted logistic regression of the outcome on logit(V) (1 = correctly dispersed, >1 = SHRUNK, <1 = over-dispersed) | `all states, <=2 per battle` | as traced | +1.0174 | +1.0695 | **-0.0521** | [-0.1235, +0.0201] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.1085) |
| calibration-in-the-large — the INTERCEPT of that regression (0 = calibrated) | `all states, <=2 per battle` | as traced | +0.3314 | +0.3471 | **-0.0157** | [-0.1361, +0.0976] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.2642) |
| calibration SLOPE — weighted logistic regression of the outcome on logit(V) | `turn 1-3, <=2 per battle` | as traced | +0.7030 | +0.7324 | **-0.0294** | [-0.1445, +0.0880] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.1802) |
| calibration-in-the-large — the INTERCEPT of that regression | `turn 1-3, <=2 per battle` | as traced | +0.9559 | +0.9827 | **-0.0268** | [-0.1983, +0.1390] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.3514) |
| calibration SLOPE with a free intercept PER own-team STRENGTH STRATUM — the dispersion reading INSIDE a stratum rather than across teams | `all states, <=2 per battle, stratum fixed effects` | MATCHED 797/269/9 | +0.9795 | +1.0065 | **-0.0270** | [-0.1042, +0.0475] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.1363) |
| calibration SLOPE on the COMMON SUPPORT — both sides restricted to the intersection of their central 95% of V, so the lever arm sd(logit V) cannot differ between them | `all states, <=2 per battle, common V window` | as traced | +1.0321 | +1.0542 | **-0.0220** | [-0.1027, +0.0567] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.1195) |
| calibration-in-the-large on the COMMON SUPPORT | `all states, <=2 per battle, common V window` | as traced | +0.3044 | +0.3683 | **-0.0639** | [-0.1958, +0.0662] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.2778) |
...
|---|---|---|---|---|
| arm `ai_v12_10_ladder_vf15` | `t1_3` | +0.1652 | +0.0140 | 11.825 |
| arm `ai_v12_10_ladder_vf15` | `t4_10` | +0.4104 | +0.0582 | 7.052 |
| arm `ai_v12_10_ladder_vf15` | `t11_24` | +0.6539 | +0.0824 | 7.938 |
...
|---|---|---|---|---|---|---|---|
| arm · team | 600 | 602 | 9531 | 19062 | 13.0 | 26.0 | 4–94 |
| arm · stratum | 5 | 602 | 9531 | 19062 | 1907.0 | 3814.0 | 1887–1925 |
| arm · between-team spread | 600 | 602 | 9531 | — | 13.0 | — | — |
...
|---|---|---|---|---|---|---|
| WITHIN-own-team Murphy resolution of V (cells >= MIN_TEAM_BATTLES battles, battle-weighted over teams) · `all states, <=2 per battle` | MATCHED 797/269/9 | +0.0489 | +0.0534 | **-0.0046** | [-0.0094, -0.0010] | **NOT DETECTED** (CI does not clear the floor 0.0044) |
| the same resolution WITHIN team-STRENGTH strata (quantiles of the team's LOO win rate) · `all states, <=2 per battle` | MATCHED 797/269/9 | +0.0287 | +0.0308 | **-0.0021** | [-0.0056, +0.0014] | **NOT DETECTED** (CI covers zero) |
| BETWEEN-team spread ratio sd(mean V) / sd(team win rate), noise-corrected · `turn 1-3` | MATCHED 797/269/9 | +1.3840 | +1.2187 | **+0.1653** | [-0.0989, +0.1378] | **WITHIN FLOOR** (|delta| <= floor 0.4324) |
| own-team leave-one-battle-out win-rate R^2 of V · `turn 1` | MATCHED 797/269/9 | +0.0732 | +0.0440 | **+0.0291** | [+0.0147, +0.0437] | **DETECTED** (CI clears the floor +0.0109) |
| own-team leave-one-battle-out win-rate R^2 of V · `turn >= 25` | MATCHED 797/269/9 | +0.0026 | +0.0043 | **-0.0017** | [-0.0083, +0.0048] | **NOT DETECTED** (CI covers zero) |
| own-team R^2 at turn 1 MINUS own-team R^2 late · `turn 1 - turn >= 25` | MATCHED 797/269/9 | +0.0706 | +0.0395 | **+0.0311** | [+0.0163, +0.0468] | **PROVISIONAL — no floor; never DETECTED** (NO FLOOR EXISTS FOR THIS ROW AND THE CONTROLS CANNOT SUPPLY ONE — every control reads own-team R^2 ~= 0 at turn 1, so there is nothing for it to FALL from and the two-draw replicate floor cannot be formed. The first replicate arm supplies it. A LARGE move either way is informative; a small one is not; and this row is never DETECTED) |
...
|---|---|---|---|---|---|---|---|---|
| arm · all | `all` | 19074 | 9537 | 0.8500 | **0.1910** | **1.8319** | [0.210, 0.998] | 0.0061 |
| arm · t1_3 | `t1_3` | 19074 | 9537 | 0.8106 | **0.1005** | **0.6568** | [0.557, 0.944] | 0.0000 |
| arm · common support | `common support` | 17433 | 9336 | 0.8609 | **0.1508** | **1.4247** | [0.400, 0.995] | 0.0000 |
...
|---|---|---|---|---|---|---|---|
| calibration SLOPE · `all states, <=2 per battle` | as traced | +1.0174 | +1.0695 | **-0.0521** | [-0.1235, +0.0201] | 0.1085 | **WITHIN FLOOR** (|delta| <= floor 0.1085) |
| calibration-in-the-large · `all states, <=2 per battle` | as traced | +0.3314 | +0.3471 | **-0.0157** | [-0.1361, +0.0976] | 0.2642 | **WITHIN FLOOR** (|delta| <= floor 0.2642) |
| calibration SLOPE · `turn 1-3, <=2 per battle` | as traced | +0.7030 | +0.7324 | **-0.0294** | [-0.1445, +0.0880] | 0.1802 | **WITHIN FLOOR** (|delta| <= floor 0.1802) |
| calibration-in-the-large · `turn 1-3, <=2 per battle` | as traced | +0.9559 | +0.9827 | **-0.0268** | [-0.1983, +0.1390] | 0.3514 | **WITHIN FLOOR** (|delta| <= floor 0.3514) |
| calibration SLOPE with a free intercept PER own-team STRENGTH STRATUM · `all states, <=2 per battle, stratum fixed effects` | MATCHED 797/269/9 | +0.9795 | +1.0065 | **-0.0270** | [-0.1042, +0.0475] | 0.1363 | **WITHIN FLOOR** (|delta| <= floor 0.1363) |
| calibration SLOPE on the COMMON SUPPORT · `all states, <=2 per battle, common V window` | as traced | +1.0321 | +1.0542 | **-0.0220** | [-0.1027, +0.0567] | 0.1195 | **WITHIN FLOOR** (|delta| <= floor 0.1195) |
| calibration-in-the-large on the COMMON SUPPORT · `all states, <=2 per battle, common V window` | as traced | +0.3044 | +0.3683 | **-0.0639** | [-0.1958, +0.0662] | 0.2778 | **WITHIN FLOOR** (|delta| <= floor 0.2778) |
...
| row | frame | arm | control | **Δ** | 95% CI | verdict |
|---|---|---|---|---|---|---|
| `cond.spread_ratio_raw.t1_3` | MATCHED · battle 797/269/9 (9458 battles, 9452 decoder battles, 21 seeds) | +0.1681 [+0.1436, +0.1516] | +0.1474 | **+0.0207** | [-0.0148, +0.0573] | **WITHIN FLOOR** (|delta| <= floor 0.0535) |
| `cond.spread_ratio_raw.t1_3` | MATCHED · decoder 996/336/9 (9525 battles, 9519 decoder battles, 21 seeds) | +0.1681 [+0.1462, +0.1497] | +0.1478 | **+0.0203** | [-0.0142, +0.0551] | **WITHIN FLOOR** (|delta| <= floor 0.0535) |
...
| `cond.own_team_r2.t1` | MATCHED · battle 797/269/9 (9458 battles, 9452 decoder battles, 21 seeds) | +0.0732 [+0.0396, +0.0498] | +0.0440 | **+0.0291** | [+0.0147, +0.0437] | **DETECTED** (CI clears the floor +0.0109) |
| `cond.own_team_r2.t1` | MATCHED · decoder 996/336/9 (9525 battles, 9519 decoder battles, 21 seeds) | +0.0732 [+0.0429, +0.0489] | +0.0465 | **+0.0267** | [+0.0117, +0.0414] | **DETECTED** (CI clears the floor +0.0109) |
| `cond.own_team_r2.t1` | UNMATCHED (as traced) | +0.0732 | +0.0475 | **+0.0257** | [+0.0109, +0.0402] | *no label — not a reading* |
| `cond.own_team_r2.all` | MATCHED · battle 797/269/9 (9458 battles, 9452 decoder battles, 21 seeds) | +0.0104 [+0.0085, +0.0123] | +0.0108 | **-0.0004** | [-0.0058, +0.0050] | **WITHIN FLOOR** (|delta| <= floor 0.0025) |
| `cond.own_team_r2.all` | MATCHED · decoder 996/336/9 (9525 battles, 9519 decoder battles, 21 seeds) | +0.0104 [+0.0093, +0.0114] | +0.0103 | **+0.0001** | [-0.0054, +0.0057] | **WITHIN FLOOR** (|delta| <= floor 0.0025) |
...
| `cond.opp_class_auc.t1_3` | MATCHED · battle 797/269/9 (9458 battles, 9452 decoder battles, 21 seeds) | +0.5576 [+0.5783, +0.5827] | +0.5803 | **-0.0227** | [-0.0397, -0.0059] | **NOT DETECTED** (CI does not clear the floor 0.0153) |
| `cond.opp_class_auc.t1_3` | MATCHED · decoder 996/336/9 (9525 battles, 9519 decoder battles, 21 seeds) | +0.5576 [+0.5784, +0.5810] | +0.5798 | **-0.0222** | [-0.0391, -0.0054] | **NOT DETECTED** (CI does not clear the floor 0.0153) |
| `cond.opp_class_auc.t1_3` | UNMATCHED (as traced) | +0.5576 | +0.5796 | **-0.0220** | [-0.0384, -0.0057] | *no label — not a reading* |
| `cond.opp_class_auc.t4_10` | MATCHED · battle 797/269/9 (9458 battles, 9452 decoder battles, 21 seeds) | +0.6278 [+0.6974, +0.7114] | +0.7093 | **-0.0815** | [-0.0961, -0.0658] | **DETECTED** (CI clears the floor +0.0219) |
| `cond.opp_class_auc.t4_10` | MATCHED · decoder 996/336/9 (9525 battles, 9519 decoder battles, 21 seeds) | +0.6278 [+0.7087, +0.7110] | +0.7103 | **-0.0825** | [-0.0976, -0.0678] | **DETECTED** (CI clears the floor +0.0219) |
| `cond.opp_class_auc.t4_10` | UNMATCHED (as traced) | +0.6278 | +0.7086 | **-0.0808** | [-0.0961, -0.0656] | *no label — not a reading* |
| `cond.spread_ratio_optimal.t1_3` | MATCHED · battle 797/269/9 (9458 battles, 9452 decoder battles, 21 seeds) | +0.0140 [+0.0166, +0.0192] | +0.0178 | **-0.0038** | [-0.0070, -0.0008] | **PROVISIONAL — no floor; never DETECTED** (a DESCRIPTIVE DECOMPOSITION TERM, never a pass/fail bar and never a treatment effect. It is the between-opponent spread ratio a head conditioning ONLY on WHICH OPPONENT its own `V` reveals would exhibit — `sum_o q(o|V)*p_o` — and it is read BESIDE `cond.spread_ratio.<window>` to split that row into an OPPONENT-IDENTITY part and a remainder. 🚨 IT IS NOT AN UPPER BOUND ON THAT ROW AND `V` ROUTINELY EXCEEDS IT: measured on the hp800 lambda09/ctrl10M pair, V reads 0.647 / 0.704 at turns 11-24 against this row's 0.214 / 0.187. A per-state conditional mean is an ATTENUATING transform, so the cell-mean spread of `E[p_o | V]` is smaller than the cell-mean spread of `V` itself; the excess is between-opponent spread that rides on BOARD STATE correlated with the opponent rather than on opponent identity. A delta between two sides is a difference in how much opponent IDENTITY each side's output carries; it is reported, and it is never DETECTED) |
| `cond.spread_ratio_optimal.t1_3` | MATCHED · decoder 996/336/9 (9525 battles, 9519 decoder battles, 21 seeds) | +0.0140 [+0.0173, +0.0184] | +0.0178 | **-0.0038** | [-0.0073, -0.0009] | **PROVISIONAL — no floor; never DETECTED** (a DESCRIPTIVE DECOMPOSITION TERM, never a pass/fail bar and never a treatment effect. It is the between-opponent spread ratio a head conditioning ONLY on WHICH OPPONENT its own `V` reveals would exhibit — `sum_o q(o|V)*p_o` — and it is read BESIDE `cond.spread_ratio.<window>` to split that row into an OPPONENT-IDENTITY part and a remainder. 🚨 IT IS NOT AN UPPER BOUND ON THAT ROW AND `V` ROUTINELY EXCEEDS IT: measured on the hp800 lambda09/ctrl10M pair, V reads 0.647 / 0.704 at turns 11-24 against this row's 0.214 / 0.187. A per-state conditional mean is an ATTENUATING transform, so the cell-mean spread of `E[p_o | V]` is smaller than the cell-mean spread of `V` itself; the excess is between-opponent spread that rides on BOARD STATE correlated with the opponent rather than on opponent identity. A delta between two sides is a difference in how much opponent IDENTITY each side's output carries; it is reported, and it is never DETECTED) |
| `cond.spread_ratio_optimal.t1_3` | UNMATCHED (as traced) | +0.0140 | +0.0181 | **-0.0041** | [-0.0073, -0.0012] | *no label — not a reading* |
| `cond.spread_ratio_optimal.t4_10` | MATCHED · battle 797/269/9 (9458 battles, 9452 decoder battles, 21 seeds) | +0.0582 [+0.1236, +0.1287] | +0.1262 | **-0.0680** | [-0.0814, -0.0558] | **PROVISIONAL — no floor; never DETECTED** (a DESCRIPTIVE DECOMPOSITION TERM, never a pass/fail bar and never a treatment effect. It is the between-opponent spread ratio a head conditioning ONLY on WHICH OPPONENT its own `V` reveals would exhibit — `sum_o q(o|V)*p_o` — and it is read BESIDE `cond.spread_ratio.<window>` to split that row into an OPPONENT-IDENTITY part and a remainder. 🚨 IT IS NOT AN UPPER BOUND ON THAT ROW AND `V` ROUTINELY EXCEEDS IT: measured on the hp800 lambda09/ctrl10M pair, V reads 0.647 / 0.704 at turns 11-24 against this row's 0.214 / 0.187. A per-state conditional mean is an ATTENUATING transform, so the cell-mean spread of `E[p_o | V]` is smaller than the cell-mean spread of `V` itself; the excess is between-opponent spread that rides on BOARD STATE correlated with the opponent rather than on opponent identity. A delta between two sides is a difference in how much opponent IDENTITY each side's output carries; it is reported, and it is never DETECTED) |
| `cond.spread_ratio_optimal.t4_10` | MATCHED · decoder 996/336/9 (9525 battles, 9519 decoder battles, 21 seeds) | +0.0582 [+0.1249, +0.1271] | +0.1262 | **-0.0680** | [-0.0831, -0.0558] | **PROVISIONAL — no floor; never DETECTED** (a DESCRIPTIVE DECOMPOSITION TERM, never a pass/fail bar and never a treatment effect. It is the between-opponent spread ratio a head conditioning ONLY on WHICH OPPONENT its own `V` reveals would exhibit — `sum_o q(o|V)*p_o` — and it is read BESIDE `cond.spread_ratio.<window>` to split that row into an OPPONENT-IDENTITY part and a remainder. 🚨 IT IS NOT AN UPPER BOUND ON THAT ROW AND `V` ROUTINELY EXCEEDS IT: measured on the hp800 lambda09/ctrl10M pair, V reads 0.647 / 0.704 at turns 11-24 against this row's 0.214 / 0.187. A per-state conditional mean is an ATTENUATING transform, so the cell-mean spread of `E[p_o | V]` is smaller than the cell-mean spread of `V` itself; the excess is between-opponent spread that rides on BOARD STATE correlated with the opponent rather than on opponent identity. A delta between two sides is a difference in how much opponent IDENTITY each side's output carries; it is reported, and it is never DETECTED) |
| `cond.spread_ratio_optimal.t4_10` | UNMATCHED (as traced) | +0.0582 | +0.1264 | **-0.0682** | [-0.0814, -0.0551] | *no label — not a reading* |
| `cond.spread_ratio_optimal.t11_24` | MATCHED · battle 797/269/9 (9458 battles, 9452 decoder battles, 21 seeds) | +0.0824 [+0.1843, +0.1887] | +0.1868 | **-0.1044** | [-0.1240, -0.0858] | **PROVISIONAL — no floor; never DETECTED** (a DESCRIPTIVE DECOMPOSITION TERM, never a pass/fail bar and never a treatment effect. It is the between-opponent spread ratio a head conditioning ONLY on WHICH OPPONENT its own `V` reveals would exhibit — `sum_o q(o|V)*p_o` — and it is read BESIDE `cond.spread_ratio.<window>` to split that row into an OPPONENT-IDENTITY part and a remainder. 🚨 IT IS NOT AN UPPER BOUND ON THAT ROW AND `V` ROUTINELY EXCEEDS IT: measured on the hp800 lambda09/ctrl10M pair, V reads 0.647 / 0.704 at turns 11-24 against this row's 0.214 / 0.187. A per-state conditional mean is an ATTENUATING transform, so the cell-mean spread of `E[p_o | V]` is smaller than the cell-mean spread of `V` itself; the excess is between-opponent spread that rides on BOARD STATE correlated with the opponent rather than on opponent identity. A delta between two sides is a difference in how much opponent IDENTITY each side's output carries; it is reported, and it is never DETECTED) |
| `cond.spread_ratio_optimal.t11_24` | MATCHED · decoder 996/336/9 (9525 battles, 9519 decoder battles, 21 seeds) | +0.0824 [+0.1856, +0.1885] | +0.1866 | **-0.1042** | [-0.1254, -0.0863] | **PROVISIONAL — no floor; never DETECTED** (a DESCRIPTIVE DECOMPOSITION TERM, never a pass/fail bar and never a treatment effect. It is the between-opponent spread ratio a head conditioning ONLY on WHICH OPPONENT its own `V` reveals would exhibit — `sum_o q(o|V)*p_o` — and it is read BESIDE `cond.spread_ratio.<window>` to split that row into an OPPONENT-IDENTITY part and a remainder. 🚨 IT IS NOT AN UPPER BOUND ON THAT ROW AND `V` ROUTINELY EXCEEDS IT: measured on the hp800 lambda09/ctrl10M pair, V reads 0.647 / 0.704 at turns 11-24 against this row's 0.214 / 0.187. A per-state conditional mean is an ATTENUATING transform, so the cell-mean spread of `E[p_o | V]` is smaller than the cell-mean spread of `V` itself; the excess is between-opponent spread that rides on BOARD STATE correlated with the opponent rather than on opponent identity. A delta between two sides is a difference in how much opponent IDENTITY each side's output carries; it is reported, and it is never DETECTED) |
| `cond.spread_ratio_optimal.t11_24` | UNMATCHED (as traced) | +0.0824 | +0.1871 | **-0.1047** | [-0.1237, -0.0850] | *no label — not a reading* |
| `cond.within_team_resolution.all` | MATCHED · battle 797/269/9 (9458 battles, 9452 decoder battles, 21 seeds) | +0.0489 [+0.0527, +0.0539] | +0.0534 | **-0.0046** | [-0.0094, -0.0010] | **NOT DETECTED** (CI does not clear the floor 0.0044) |
| `cond.within_team_resolution.all` | MATCHED · decoder 996/336/9 (9525 battles, 9519 decoder battles, 21 seeds) | +0.0489 [+0.0527, +0.0537] | +0.0531 | **-0.0042** | [-0.0097, -0.0014] | **WITHIN FLOOR** (|delta| <= floor 0.0044) |
| `cond.within_team_resolution.all` | UNMATCHED (as traced) | +0.0489 | +0.0531 | **-0.0042** | [-0.0100, -0.0015] | *no label — not a reading* |
| `cond.within_stratum_resolution.all` | MATCHED · battle 797/269/9 (9458 battles, 9452 decoder battles, 21 seeds) | +0.0287 [+0.0306, +0.0313] | +0.0308 | **-0.0021** | [-0.0056, +0.0014] | **NOT DETECTED** (CI covers zero) |
| `cond.within_stratum_resolution.all` | MATCHED · decoder 996/336/9 (9525 battles, 9519 decoder battles, 21 seeds) | +0.0287 [+0.0304, +0.0312] | +0.0310 | **-0.0022** | [-0.0059, +0.0013] | **NOT DETECTED** (CI covers zero) |
| `cond.within_stratum_resolution.all` | UNMATCHED (as traced) | +0.0287 | +0.0308 | **-0.0021** | [-0.0058, +0.0015] | *no label — not a reading* |
| `cond.team_spread_ratio.t1_3` | MATCHED · battle 797/269/9 (9458 battles, 9452 decoder battles, 21 seeds) | +1.3840 [+1.1652, +1.3113] | +1.2187 | **+0.1653** | [-0.0989, +0.1378] | **WITHIN FLOOR** (|delta| <= floor 0.4324) |
| `cond.team_spread_ratio.t1_3` | MATCHED · decoder 996/336/9 (9525 battles, 9519 decoder battles, 21 seeds) | +1.3840 [+1.1992, +1.2781] | +1.2450 | **+0.1390** | [-0.1041, +0.1218] | **WITHIN FLOOR** (|delta| <= floor 0.4324) |
| `cond.team_spread_ratio.t1_3` | UNMATCHED (as traced) | +1.3840 | +1.2523 | **+0.1317** | [-0.1116, +0.1276] | *no label — not a reading* |
| `cond.team_spread_ratio_raw.t1_3` | MATCHED · battle 797/269/9 (9458 battles, 9452 decoder battles, 21 seeds) | +0.6812 [+0.6545, +0.6731] | +0.6645 | **+0.0167** | [-0.0511, +0.0538] | **WITHIN FLOOR** (|delta| <= floor 0.2507) |
| `cond.team_spread_ratio_raw.t1_3` | MATCHED · decoder 996/336/9 (9525 battles, 9519 decoder battles, 21 seeds) | +0.6812 [+0.6686, +0.6800] | +0.6745 | **+0.0067** | [-0.0564, +0.0482] | **WITHIN FLOOR** (|delta| <= floor 0.2507) |
| `cond.team_spread_ratio_raw.t1_3` | UNMATCHED (as traced) | +0.6812 | +0.6791 | **+0.0022** | [-0.0620, +0.0476] | *no label — not a reading* |
| `cond.own_team_r2.late` | MATCHED · battle 797/269/9 (9458 battles, 9452 decoder battles, 21 seeds) | +0.0026 [+0.0021, +0.0075] | +0.0043 | **-0.0017** | [-0.0083, +0.0048] | **NOT DETECTED** (CI covers zero) |
| `cond.own_team_r2.late` | MATCHED · decoder 996/336/9 (9525 battles, 9519 decoder battles, 21 seeds) | +0.0026 [+0.0028, +0.0069] | +0.0045 | **-0.0020** | [-0.0081, +0.0037] | **NOT DETECTED** (CI covers zero) |
| `cond.own_team_r2.late` | UNMATCHED (as traced) | +0.0026 | +0.0050 | **-0.0025** | [-0.0083, +0.0035] | *no label — not a reading* |
| `cond.own_team_r2.t1_minus_late` | MATCHED · battle 797/269/9 (9458 battles, 9452 decoder battles, 21 seeds) | +0.0706 [+0.0352, +0.0459] | +0.0395 | **+0.0311** | [+0.0163, +0.0468] | **PROVISIONAL — no floor; never DETECTED** (NO FLOOR EXISTS FOR THIS ROW AND THE CONTROLS CANNOT SUPPLY ONE — every control reads own-team R^2 ~= 0 at turn 1, so there is nothing for it to FALL from and the two-draw replicate floor cannot be formed. The first replicate arm supplies it. A LARGE move either way is informative; a small one is not; and this row is never DETECTED) |
| `cond.own_team_r2.t1_minus_late` | MATCHED · decoder 996/336/9 (9525 battles, 9519 decoder battles, 21 seeds) | +0.0706 [+0.0380, +0.0448] | +0.0416 | **+0.0289** | [+0.0130, +0.0442] | **PROVISIONAL — no floor; never DETECTED** (NO FLOOR EXISTS FOR THIS ROW AND THE CONTROLS CANNOT SUPPLY ONE — every control reads own-team R^2 ~= 0 at turn 1, so there is nothing for it to FALL from and the two-draw replicate floor cannot be formed. The first replicate arm supplies it. A LARGE move either way is informative; a small one is not; and this row is never DETECTED) |
| `cond.own_team_r2.t1_minus_late` | UNMATCHED (as traced) | +0.0706 | +0.0424 | **+0.0282** | [+0.0134, +0.0434] | *no label — not a reading* |
| `cond.calibration_slope.within_stratum` | MATCHED · battle 797/269/9 (9458 battles, 9452 decoder battles, 21 seeds) | +0.9795 [+0.9977, +1.0125] | +1.0065 | **-0.0270** | [-0.1042, +0.0475] | **WITHIN FLOOR** (|delta| <= floor 0.1363) |
| `cond.calibration_slope.within_stratum` | MATCHED · decoder 996/336/9 (9525 battles, 9519 decoder battles, 21 seeds) | +0.9795 [+0.9918, +1.0054] | +0.9961 | **-0.0166** | [-0.0897, +0.0566] | **WITHIN FLOOR** (|delta| <= floor 0.1363) |
| `cond.calibration_slope.within_stratum` | UNMATCHED (as traced) | +0.9795 | +1.0200 | **-0.0405** | [-0.1091, +0.0342] | *no label — not a reading* |
...
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected · `turn 4-10` | +0.4104 | [+0.3557, +0.4693] | +0.5080 | [+0.4626, +0.5569] |
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected · `turn 11-24` | +0.6539 | [+0.5713, +0.7456] | +0.7039 | [+0.6391, +0.7725] |
...
| opponent-CLASS (pool vs bot) AUC of V · `turn 1-3` | +0.5576 | [+0.5462, +0.5687] | +0.5796 | [+0.5675, +0.5917] |
| opponent-CLASS (pool vs bot) AUC of V · `turn 4-10` | +0.6278 | [+0.6171, +0.6390] | +0.7086 | [+0.6987, +0.7188] |
| OPPONENT-DECODABLE between-opponent spread ratio — sum_o q(o|V)*p_o, noise-corrected (NOT a bound on the row above) · `turn 1-3` | +0.0140 | [+0.0122, +0.0162] | +0.0181 | [+0.0159, +0.0207] |
| OPPONENT-DECODABLE between-opponent spread ratio — sum_o q(o|V)*p_o, noise-corrected (NOT a bound on the row above) · `turn 4-10` | +0.0582 | [+0.0512, +0.0656] | +0.1264 | [+0.1157, +0.1380] |
| OPPONENT-DECODABLE between-opponent spread ratio — sum_o q(o|V)*p_o, noise-corrected (NOT a bound on the row above) · `turn 11-24` | +0.0824 | [+0.0723, +0.0931] | +0.1871 | [+0.1713, +0.2033] |
| WITHIN-own-team Murphy resolution of V (cells >= MIN_TEAM_BATTLES battles, battle-weighted over teams) · `all states, <=2 per battle` | +0.0489 | [+0.0486, +0.0543] | +0.0531 | [+0.0541, +0.0601] |
| the same resolution WITHIN team-STRENGTH strata (quantiles of the team's LOO win rate) · `all states, <=2 per battle` | +0.0287 | [+0.0265, +0.0315] | +0.0308 | [+0.0285, +0.0338] |
| BETWEEN-team spread ratio sd(mean V) / sd(team win rate), noise-corrected · `turn 1-3` | +1.3840 | [+0.6104, +0.7780] | +1.2523 | [+0.6046, +0.7674] |
| the same ratio UNCORRECTED and unclamped · `turn 1-3` | +0.6812 | [+0.4912, +0.5669] | +0.6791 | [+0.4983, +0.5740] |
| own-team leave-one-battle-out win-rate R^2 of V · `turn >= 25` | +0.0026 | [-0.0022, +0.0064] | +0.0050 | [+0.0006, +0.0091] |
| own-team R^2 at turn 1 MINUS own-team R^2 late · `turn 1 - turn >= 25` | +0.0706 | [+0.0589, +0.0827] | +0.0424 | [+0.0327, +0.0523] |
| calibration SLOPE — weighted logistic regression of the outcome on logit(V) (1 = correctly dispersed, >1 = SHRUNK, <1 = over-dispersed) · `all states, <=2 per battle` | +1.0174 | [+0.9700, +1.0683] | +1.0695 | [+1.0223, +1.1229] |
| calibration-in-the-large — the INTERCEPT of that regression (0 = calibrated) · `all states, <=2 per battle` | +0.3314 | [+0.2380, +0.4161] | +0.3471 | [+0.2648, +0.4224] |
| calibration SLOPE — weighted logistic regression of the outcome on logit(V) · `turn 1-3, <=2 per battle` | +0.7030 | [+0.6208, +0.7898] | +0.7324 | [+0.6476, +0.8189] |
| calibration-in-the-large — the INTERCEPT of that regression · `turn 1-3, <=2 per battle` | +0.9559 | [+0.8271, +1.0793] | +0.9827 | [+0.8779, +1.0856] |
| calibration SLOPE with a free intercept PER own-team STRENGTH STRATUM — the dispersion reading INSIDE a stratum rather than across teams · `all states, <=2 per battle, stratum fixed effects` | +0.9795 | [+0.9309, +1.0322] | +1.0200 | [+0.9727, +1.0739] |
| calibration SLOPE on the COMMON SUPPORT — both sides restricted to the intersection of their central 95% of V, so the lever arm sd(logit V) cannot differ between them · `all states, <=2 per battle, common V window` | +1.0321 | [+0.9761, +1.0902] | +1.0542 | [+0.9996, +1.1146] |
| calibration-in-the-large on the COMMON SUPPORT · `all states, <=2 per battle, common V window` | +0.3044 | [+0.2075, +0.3973] | +0.3683 | [+0.2755, +0.4524] |
...
```
ai_v12_10_ladder_vf15 vs ai_v12_11_ladder_ctrl10M at 10M [OFFLINE-GENERATED: 800 games x 9+3 opponents, full capture]: G1 bot Δ +0.0068 [+0.0015, +0.0125] WITHIN FLOOR · identity bias late Δ +0.0218 [-0.0173, +0.0616] WITHIN FLOOR · turn-contrast Δ -0.0888 [-0.2171, +0.0408] WITHIN FLOOR · spread ratio t1-3 Δ +0.0198 [-0.0151, +0.0574] WITHIN FLOOR · own-team R2 t1 Δ +0.0291 [+0.0147, +0.0437] DETECTED [QUOTA-MATCHED] · calib slope Δ -0.0521 [-0.1235, +0.0201] WITHIN FLOOR
```
...
| this report | `/home/goodlad/.claude/jobs/9ab51de6/tmp/hp_eval/hp800/reads/ai_v12_10_ladder_vf15_vs_ctrl10M_v6/critic_read.md` |
| machine-readable | `/home/goodlad/.claude/jobs/9ab51de6/tmp/hp_eval/hp800/reads/ai_v12_10_ladder_vf15_vs_ctrl10M_v6/critic_read.json` |
