...
The critic ladder's registered read (ledger 2026-09-08 *REGISTRATION · THE CRITIC LADDER*), produced by `python -m main.ops.critic_read` v3 at 2026-09-09T10:28:51. Every number is a DELTA, **arm − control**, with the difference of the two runs' independent battle-clustered bootstraps. Strength is NOT read.
...
|---|---|---|---|---|---|
| arm | `ai_v12_13_ladder_tdaux` | **8/12/2** | 210 | 96 / 104 / 10 | 12 |
...
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected · `turn 1-3` | as traced | +0.0000 | +0.1152 | **-0.1152** | [-0.5134, +0.3248] | **NOT DETECTED** (CI covers zero) |
| own-team leave-one-battle-out win-rate R^2 of V · `turn 1` | as traced (frames equal) | -0.0382 | -0.0237 | **-0.0145** | [-0.1037, +0.0595] | **NOT DETECTED** (CI covers zero) |
...
|---|---|---|---|---|---|---|---|---|
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected ⭐ | `turn 1-3` | as traced | +0.0000 | +0.1152 | **-0.1152** | [-0.5134, +0.3248] | 2000 | **NOT DETECTED** (CI covers zero) |
| the same ratio UNCORRECTED and unclamped | `turn 1-3` | as traced (frames equal) | +0.1984 | +0.3333 | **-0.1349** | [-0.3291, +0.2370] | 2000 | **NOT DETECTED** (CI covers zero) |
| sd(V) - sd(outcome), noise-corrected | `turn 1-3` | as traced | -0.0608 | -0.0886 | **+0.0278** | [-0.0298, +0.0641] | 2000 | **NOT DETECTED** (CI covers zero) |
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected | `all states` | as traced | +0.5360 | +0.7895 | **-0.2535** | [-0.6523, +0.3909] | 2000 | **NOT DETECTED** (CI covers zero) |
| the same ratio UNCORRECTED and unclamped | `all states` | as traced (frames equal) | +0.6396 | +0.8053 | **-0.1657** | [-0.5317, +0.3365] | 2000 | **NOT DETECTED** (CI covers zero) |
| sd(V) - sd(outcome), noise-corrected | `all states` | as traced | -0.0282 | -0.0211 | **-0.0071** | [-0.0505, +0.0421] | 2000 | **NOT DETECTED** (CI covers zero) |
| slope of bias (V - true win rate) on opponent Elo, per 100 Elo | `all states` | as traced | +0.0124 | +0.0098 | **+0.0026** | [-0.0120, +0.0173] | 2000 | **NOT DETECTED** (CI covers zero) |
| own-team leave-one-battle-out win-rate R^2 of V ⭐ | `turn 1` | as traced (frames equal) | -0.0382 | -0.0237 | **-0.0145** | [-0.1037, +0.0595] | 2000 | **NOT DETECTED** (CI covers zero) |
| own-team leave-one-battle-out win-rate R^2 of V | `all states` | as traced (frames equal) | -0.0117 | -0.0098 | **-0.0019** | [-0.1240, +0.1287] | 2000 | **NOT DETECTED** (CI covers zero) |
| opponent-CLASS (pool vs bot) AUC of V | `turn 1` | as traced (frames equal) | +0.4345 | +0.4619 | **-0.0275** | [-0.1728, +0.1246] | 2000 | **NOT DETECTED** (CI covers zero) |
...
python -m main.ops.critic_read ai_v12_13_ladder_tdaux --control ai_v12_11_ladder_ctrl10M --step 10000032 --out /home/goodlad/.claude/jobs/9ab51de6/tmp/reads_v3/tdaux
...
| this report | `/home/goodlad/.claude/jobs/9ab51de6/tmp/reads_v3/tdaux/critic_read.md` |
| machine-readable | `/home/goodlad/.claude/jobs/9ab51de6/tmp/reads_v3/tdaux/critic_read.json` |
