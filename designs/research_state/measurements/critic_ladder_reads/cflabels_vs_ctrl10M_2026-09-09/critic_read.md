...
The critic ladder's registered read (ledger 2026-09-08 *REGISTRATION · THE CRITIC LADDER*), produced by `python -m main.ops.critic_read` v2 at 2026-09-09T08:17:31. Every number is a DELTA, **arm − control**, with the difference of the two runs' independent battle-clustered bootstraps. Strength is NOT read.
...
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected · `turn 1-3` | +0.0000 | +0.1152 | **-0.1152** | [-0.5230, +0.0879] | **NOT DETECTED** (CI covers zero) |
| own-team leave-one-battle-out win-rate R^2 of V · `turn 1` | +0.0604 | -0.0237 | **+0.0841** | [+0.0323, +0.1825] | **DETECTED** (vs ZERO — NO FLOOR) |
...
|---|---|---|---|---|---|---|---|
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected ⭐ | `turn 1-3` | +0.0000 | +0.1152 | **-0.1152** | [-0.5230, +0.0879] | 2000 | **NOT DETECTED** (CI covers zero) |
| the same ratio UNCORRECTED and unclamped | `turn 1-3` | +0.1077 | +0.3333 | **-0.2256** | [-0.5187, -0.1046] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| sd(V) - sd(outcome), noise-corrected | `turn 1-3` | -0.1026 | -0.0886 | **-0.0140** | [-0.0701, +0.0189] | 2000 | **NOT DETECTED** (CI covers zero) |
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected | `all states` | +0.5149 | +0.7895 | **-0.2746** | [-0.6919, +0.0168] | 2000 | **NOT DETECTED** (CI covers zero) |
| the same ratio UNCORRECTED and unclamped | `all states` | +0.5108 | +0.8053 | **-0.2945** | [-0.6714, -0.0316] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| sd(V) - sd(outcome), noise-corrected | `all states` | -0.0498 | -0.0211 | **-0.0287** | [-0.0762, +0.0104] | 2000 | **NOT DETECTED** (CI covers zero) |
| slope of bias (V - true win rate) on opponent Elo, per 100 Elo | `all states` | +0.0191 | +0.0098 | **+0.0093** | [-0.0026, +0.0222] | 2000 | **NOT DETECTED** (CI covers zero) |
| own-team leave-one-battle-out win-rate R^2 of V ⭐ | `turn 1` | +0.0604 | -0.0237 | **+0.0841** | [+0.0323, +0.1825] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| own-team leave-one-battle-out win-rate R^2 of V | `all states` | +0.0837 | -0.0098 | **+0.0935** | [+0.0252, +0.1836] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| opponent-CLASS (pool vs bot) AUC of V | `turn 1` | +0.5552 | +0.4619 | **+0.0933** | [-0.0209, +0.2022] | 2000 | **NOT DETECTED** (CI covers zero) |
...
```
ai_v12_12_ladder_cflabels vs ai_v12_11_ladder_ctrl10M at 10M: G1 bot Δ +0.0054 [-0.0121, +0.0191] NOT DETECTED · identity bias late Δ +0.0380 [-0.0382, +0.1122] NOT DETECTED · turn-contrast Δ +0.1928 [-0.0549, +0.4084] NOT DETECTED · spread ratio t1-3 Δ -0.1152 [-0.5230, +0.0879] NOT DETECTED · own-team R2 t1 Δ +0.0841 [+0.0323, +0.1825] DETECTED
```
...
python -m main.ops.critic_read ai_v12_12_ladder_cflabels --control ai_v12_11_ladder_ctrl10M --step 10000032 --out /home/goodlad/.claude/jobs/9ab51de6/tmp/read_cflabels

# arm — ai_v12_12_ladder_cflabels
  /home/goodlad/miniconda3/envs/gen3ai_stable/bin/python3 -m agents.training.cf_audit /home/goodlad/dev/gen3ai/models/ai_v12_12_ladder_cflabels --step 10000032 --impl rust --rollouts 8 --states 800 --anchors 150 --seed 0 --anchor-tolerance 0.9 --out /home/goodlad/.claude/jobs/9ab51de6/tmp/read_cflabels/identity
  /home/goodlad/miniconda3/envs/gen3ai_stable/bin/python3 -m main.critic_gate /home/goodlad/dev/gen3ai/models/ai_v12_12_ladder_cflabels --parent v9_fold_parent --famine-comparator off --skip-meter --boot 400 --seed 0 --reliability-bins 10 --json /home/goodlad/.claude/jobs/9ab51de6/tmp/read_cflabels/gate/critic_gate.json --md /home/goodlad/.claude/jobs/9ab51de6/tmp/read_cflabels/gate/critic_gate.md
...
| this report | `/home/goodlad/.claude/jobs/9ab51de6/tmp/read_cflabels/critic_read.md` |
| machine-readable | `/home/goodlad/.claude/jobs/9ab51de6/tmp/read_cflabels/critic_read.json` |
