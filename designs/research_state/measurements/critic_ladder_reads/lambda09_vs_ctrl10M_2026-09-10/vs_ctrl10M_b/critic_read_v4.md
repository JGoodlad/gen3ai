...
The critic ladder's registered read (ledger 2026-09-08 *REGISTRATION · THE CRITIC LADDER*), produced by `python -m main.ops.critic_read` v4 at 2026-09-10T07:32:50. Every number is a DELTA, **arm − control**, with the difference of the two runs' independent battle-clustered bootstraps. Strength is NOT read.
...
| the same resolution WITHIN team-STRENGTH strata (quantiles of the team's LOO win rate) | `all states, <=2 per battle` | MATCHED 40/37/2 | +0.0355 | +0.0412 | **-0.0057** | [-0.0213, +0.0089] | 2000 | **NOT DETECTED** (CI covers zero) |
| BETWEEN-team spread ratio sd(mean V) / sd(team win rate), noise-corrected | `turn 1-3` | MATCHED 40/37/2 | +0.1631 | +0.2620 | **-0.0989** | [-0.1399, -0.0119] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| the same ratio UNCORRECTED and unclamped | `turn 1-3` | MATCHED 40/37/2 | +0.1521 | +0.2212 | **-0.0691** | [-0.0953, -0.0149] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| own-team leave-one-battle-out win-rate R^2 of V | `turn >= 25` | MATCHED 40/37/2 | +0.2262 | +0.0699 | **+0.1563** | [+0.0214, +0.2881] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
...
| the same resolution WITHIN team-STRENGTH strata (quantiles of the team's LOO win rate) · `all states, <=2 per battle` | MATCHED 40/37/2 | +0.0355 | +0.0412 | **-0.0057** | [-0.0213, +0.0089] | **NOT DETECTED** (CI covers zero) |
| BETWEEN-team spread ratio sd(mean V) / sd(team win rate), noise-corrected · `turn 1-3` | MATCHED 40/37/2 | +0.1631 | +0.2620 | **-0.0989** | [-0.1399, -0.0119] | **DETECTED** (vs ZERO — NO FLOOR) |
| own-team leave-one-battle-out win-rate R^2 of V · `turn 1` | MATCHED 40/37/2 | +0.1420 | -0.0041 | **+0.1460** | [+0.0638, +0.2279] | **DETECTED** (CI clears the floor +0.0389) |
| own-team leave-one-battle-out win-rate R^2 of V · `turn >= 25` | MATCHED 40/37/2 | +0.2262 | +0.0699 | **+0.1563** | [+0.0214, +0.2881] | **DETECTED** (vs ZERO — NO FLOOR) |
...
| `cond.within_stratum_resolution.all` | MATCHED · battle 40/37/2 (651 battles, 460 decoder battles, 21 seeds) | +0.0355 [+0.0388, +0.0433] | +0.0412 | **-0.0057** | [-0.0213, +0.0089] | **NOT DETECTED** (CI covers zero) |
| `cond.within_stratum_resolution.all` | MATCHED · decoder 45/42/2 (652 battles, 461 decoder battles, 21 seeds) | +0.0355 [+0.0433, +0.0433] | +0.0433 | **-0.0078** | [-0.0233, +0.0057] | **NOT DETECTED** (CI covers zero) |
| `cond.within_stratum_resolution.all` | UNMATCHED (as traced) | +0.0355 | +0.0433 | **-0.0078** | [-0.0233, +0.0057] | *no label — not a reading* |
| `cond.team_spread_ratio.t1_3` | MATCHED · battle 40/37/2 (651 battles, 460 decoder battles, 21 seeds) | +0.1631 [+0.2610, +0.2640] | +0.2620 | **-0.0989** | [-0.1399, -0.0119] | **DETECTED** (vs ZERO — NO FLOOR) |
| `cond.team_spread_ratio.t1_3` | MATCHED · decoder 45/42/2 (652 battles, 461 decoder battles, 21 seeds) | +0.1631 [+0.2626, +0.2626] | +0.2626 | **-0.0994** | [-0.1362, -0.0101] | **DETECTED** (vs ZERO — NO FLOOR) |
| `cond.team_spread_ratio.t1_3` | UNMATCHED (as traced) | +0.1631 | +0.2626 | **-0.0994** | [-0.1362, -0.0101] | *no label — not a reading* |
| `cond.team_spread_ratio_raw.t1_3` | MATCHED · battle 40/37/2 (651 battles, 460 decoder battles, 21 seeds) | +0.1521 [+0.2208, +0.2222] | +0.2212 | **-0.0691** | [-0.0953, -0.0149] | **DETECTED** (vs ZERO — NO FLOOR) |
| `cond.team_spread_ratio_raw.t1_3` | MATCHED · decoder 45/42/2 (652 battles, 461 decoder battles, 21 seeds) | +0.1521 [+0.2216, +0.2216] | +0.2216 | **-0.0695** | [-0.0942, -0.0141] | **DETECTED** (vs ZERO — NO FLOOR) |
| `cond.team_spread_ratio_raw.t1_3` | UNMATCHED (as traced) | +0.1521 | +0.2216 | **-0.0695** | [-0.0942, -0.0141] | *no label — not a reading* |
| `cond.own_team_r2.late` | MATCHED · battle 40/37/2 (651 battles, 460 decoder battles, 21 seeds) | +0.2262 [+0.0579, +0.0872] | +0.0699 | **+0.1563** | [+0.0214, +0.2881] | **DETECTED** (vs ZERO — NO FLOOR) |
| `cond.own_team_r2.late` | MATCHED · decoder 45/42/2 (652 battles, 461 decoder battles, 21 seeds) | +0.2262 [+0.0561, +0.0561] | +0.0561 | **+0.1701** | [+0.0348, +0.2970] | **DETECTED** (vs ZERO — NO FLOOR) |
...
```
ai_v12_19_ladder_lambda09 vs ai_v12_15_ladder_ctrl10M_b at 10M: G1 bot Δ +0.0090 [-0.0094, +0.0266] WITHIN FLOOR · identity bias late Δ -0.0237 [-0.0736, +0.0273] WITHIN FLOOR · turn-contrast Δ +0.0303 [-0.1359, +0.1865] WITHIN FLOOR · spread ratio t1-3 Δ -0.0324 [-0.1115, +0.0680] NOT DETECTED · own-team R2 t1 Δ +0.1460 [+0.0638, +0.2279] DETECTED [QUOTA-MATCHED]
```
...
python -m main.ops.critic_read ai_v12_19_ladder_lambda09 --control ai_v12_15_ladder_ctrl10M_b --step 10000032 --floor-json /home/goodlad/.claude/jobs/9ab51de6/tmp/replicate_floor_10M.json --out /home/goodlad/.claude/jobs/9ab51de6/tmp/read_lambda10M_v4_vs_ai_v12_15_ladder_ctrl10M_b
...
| this report | `/home/goodlad/.claude/jobs/9ab51de6/tmp/read_lambda10M_v4_vs_ai_v12_15_ladder_ctrl10M_b/critic_read.md` |
| machine-readable | `/home/goodlad/.claude/jobs/9ab51de6/tmp/read_lambda10M_v4_vs_ai_v12_15_ladder_ctrl10M_b/critic_read.json` |
