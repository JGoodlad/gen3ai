...
The critic ladder's registered read (ledger 2026-09-08 *REGISTRATION · THE CRITIC LADDER*), produced by `python -m main.ops.critic_read` v5 at 2026-09-10T11:39:31. Every number is a DELTA, **arm − control**, with the difference of the two runs' independent battle-clustered bootstraps. Strength is NOT read.
...
| bias V - p_hat · `late (turn>=25)` | — | -0.0184 | -0.0308 | **+0.0124** | [-0.0365, +0.0639] | **NOT DETECTED** (CI covers zero) |
| corr(turn,V) - corr(turn,MC) · `ALL` | — | -0.1121 | +0.0124 | **-0.1246** | [-0.2787, +0.0314] | **NOT DETECTED** (CI covers zero) |
| skill · `bot` | — | +0.2307 | +0.1636 | **+0.0671** | [+0.0049, +0.1395] | **DETECTED** (vs ZERO — NO FLOOR) |
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected · `turn 1-3` | as traced | +0.0538 | +0.1774 | **-0.1236** | [-0.1607, -0.0895] | **DETECTED** (vs ZERO — NO FLOOR) |
| own-team leave-one-battle-out win-rate R^2 of V · `turn 1` | MATCHED 397/188/4 | +0.0359 | +0.0386 | **-0.0027** | [-0.0193, +0.0135] | **NOT DETECTED** (CI covers zero) |
...
|---|---|---|---|---|---|---|---|---|
| resolution ⭐ | `all` | `capture-rate (gauge)` | +0.0495 | +0.0395 | **+0.0100** | [+0.0018, +0.0183] | 400 | **DETECTED** (vs ZERO — NO FLOOR) |
| resolution ⭐ | `bot` | `capture-rate (gauge)` | +0.0225 | +0.0202 | **+0.0023** | [-0.0044, +0.0091] | 400 | **NOT DETECTED** (CI covers zero) |
| resolution ⭐ | `pool` | `capture-rate (gauge)` | +0.0745 | +0.0544 | **+0.0201** | [+0.0048, +0.0330] | 400 | **DETECTED** (vs ZERO — NO FLOOR) |
| reliability | `all` | `capture-rate (gauge)` | +0.0014 | +0.0013 | **+0.0001** | [-0.0013, +0.0019] | 400 | **NOT DETECTED** (CI covers zero) |
| reliability | `bot` | `capture-rate (gauge)` | +0.0007 | +0.0036 | **-0.0029** | [-0.0052, -0.0011] | 400 | **DETECTED** (vs ZERO — NO FLOOR) |
| reliability | `pool` | `capture-rate (gauge)` | +0.0082 | +0.0022 | **+0.0060** | [+0.0007, +0.0129] | 400 | **DETECTED** (vs ZERO — NO FLOOR) |
| ece | `all` | `capture-rate (gauge)` | +0.0265 | +0.0206 | **+0.0060** | [-0.0071, +0.0187] | 400 | **NOT DETECTED** (CI covers zero) |
| ece | `bot` | `capture-rate (gauge)` | +0.0244 | +0.0394 | **-0.0150** | [-0.0300, +0.0003] | 400 | **NOT DETECTED** (CI covers zero) |
| ece | `pool` | `capture-rate (gauge)` | +0.0774 | +0.0379 | **+0.0395** | [+0.0061, +0.0673] | 400 | **DETECTED** (vs ZERO — NO FLOOR) |
| skill ⭐ | `all` | `capture-rate (gauge)` | +0.3244 | +0.2535 | **+0.0709** | [+0.0311, +0.1142] | 400 | **DETECTED** (vs ZERO — NO FLOOR) |
| skill ⭐ | `bot` | `capture-rate (gauge)` | +0.2307 | +0.1636 | **+0.0671** | [+0.0049, +0.1395] | 400 | **DETECTED** (vs ZERO — NO FLOOR) |
| skill ⭐ | `pool` | `capture-rate (gauge)` | +0.3040 | +0.2446 | **+0.0594** | [-0.0024, +0.1247] | 400 | **NOT DETECTED** (CI covers zero) |

## 2. IDENTITY — V against the Monte-Carlo continuation

| quantity | stratum | weighting | arm | control | **Δ** | 95% CI | n draws | verdict |
|---|---|---|---|---|---|---|---|---|
| bias V - p_hat | `ALL` | `raw` | +0.0425 | +0.0055 | **+0.0369** | [+0.0090, +0.0654] | 4000 | **DETECTED** (vs ZERO — NO FLOOR) |
| bias V - p_hat | `ALL` | `pop` | -0.0070 | -0.0391 | **+0.0321** | [+0.0105, +0.0529] | 4000 | **DETECTED** (vs ZERO — NO FLOOR) |
| bias V - p_hat ⭐ | `ALL` | `ipw` | -0.0070 | -0.0391 | **+0.0321** | [+0.0105, +0.0529] | 4000 | **DETECTED** (vs ZERO — NO FLOOR) |
| bias V - p_hat | `early (turn<=10)` | `raw` | +0.0544 | -0.0196 | **+0.0740** | [+0.0303, +0.1168] | 4000 | **DETECTED** (vs ZERO — NO FLOOR) |
| bias V - p_hat | `early (turn<=10)` | `pop` | -0.0035 | -0.0675 | **+0.0640** | [+0.0301, +0.0986] | 4000 | **DETECTED** (vs ZERO — NO FLOOR) |
| bias V - p_hat ⭐ | `early (turn<=10)` | `ipw` | -0.0035 | -0.0675 | **+0.0640** | [+0.0301, +0.0986] | 4000 | **DETECTED** (vs ZERO — NO FLOOR) |
| bias V - p_hat | `mid (11-24)` | `raw` | +0.0394 | +0.0143 | **+0.0252** | [-0.0154, +0.0623] | 4000 | **NOT DETECTED** (CI covers zero) |
| bias V - p_hat | `mid (11-24)` | `pop` | -0.0037 | -0.0228 | **+0.0191** | [-0.0100, +0.0466] | 4000 | **NOT DETECTED** (CI covers zero) |
| bias V - p_hat ⭐ | `mid (11-24)` | `ipw` | -0.0037 | -0.0228 | **+0.0191** | [-0.0100, +0.0466] | 4000 | **NOT DETECTED** (CI covers zero) |
| bias V - p_hat | `late (turn>=25)` | `raw` | +0.0298 | +0.0241 | **+0.0057** | [-0.0566, +0.0681] | 4000 | **NOT DETECTED** (CI covers zero) |
| bias V - p_hat | `late (turn>=25)` | `pop` | -0.0184 | -0.0308 | **+0.0124** | [-0.0365, +0.0639] | 4000 | **NOT DETECTED** (CI covers zero) |
| bias V - p_hat ⭐ | `late (turn>=25)` | `ipw` | -0.0184 | -0.0308 | **+0.0124** | [-0.0365, +0.0639] | 4000 | **NOT DETECTED** (CI covers zero) |
| bias V - p_hat | `bot` | `raw` | +0.0097 | -0.0033 | **+0.0130** | [-0.0195, +0.0450] | 4000 | **NOT DETECTED** (CI covers zero) |
| bias V - p_hat | `bot` | `pop` | -0.0313 | -0.0473 | **+0.0161** | [-0.0057, +0.0371] | 4000 | **NOT DETECTED** (CI covers zero) |
| bias V - p_hat ⭐ | `bot` | `ipw` | -0.0313 | -0.0473 | **+0.0161** | [-0.0057, +0.0371] | 4000 | **NOT DETECTED** (CI covers zero) |
| bias V - p_hat | `pool` | `raw` | +0.0957 | +0.0210 | **+0.0747** | [+0.0250, +0.1239] | 4000 | **DETECTED** (vs ZERO — NO FLOOR) |
| bias V - p_hat | `pool` | `pop` | +0.0422 | -0.0230 | **+0.0652** | [+0.0194, +0.1119] | 4000 | **DETECTED** (vs ZERO — NO FLOOR) |
| bias V - p_hat ⭐ | `pool` | `ipw` | +0.0422 | -0.0230 | **+0.0652** | [+0.0194, +0.1119] | 4000 | **DETECTED** (vs ZERO — NO FLOOR) |
...
| Murphy skill_score | `ALL` | `raw` | +0.2036 | +0.1567 | **+0.0469** | [-0.0232, +0.1211] | 4000 | **NOT DETECTED** (CI covers zero) |
| Murphy skill_score | `ALL` | `pop` | +0.3131 | +0.2213 | **+0.0919** | [+0.0027, +0.1900] | 4000 | **DETECTED** (vs ZERO — NO FLOOR) |
| Murphy skill_score ⭐ | `ALL` | `ipw` | +0.3131 | +0.2213 | **+0.0919** | [+0.0027, +0.1900] | 4000 | **DETECTED** (vs ZERO — NO FLOOR) |
...
| Murphy reliability | `ALL` | `raw` | +0.0038 | +0.0031 | **+0.0007** | [-0.0039, +0.0048] | 4000 | **NOT DETECTED** (CI covers zero) |
...
|---|---|---|---|---|---|---|---|---|
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected ⭐ | `turn 1-3` | as traced | +0.0538 | +0.1774 | **-0.1236** | [-0.1607, -0.0895] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| the same ratio UNCORRECTED and unclamped | `turn 1-3` | MATCHED 397/188/4 | +0.0570 | +0.1803 | **-0.1233** | [-0.1597, -0.0905] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| sd(V) - sd(outcome), noise-corrected | `turn 1-3` | as traced | -0.1218 | -0.0987 | **-0.0231** | [-0.0415, -0.0041] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected | `all states` | as traced | +0.5511 | +0.6680 | **-0.1169** | [-0.2258, -0.0081] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| the same ratio UNCORRECTED and unclamped | `all states` | MATCHED 397/188/4 | +0.5486 | +0.6644 | **-0.1159** | [-0.2277, -0.0114] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| sd(V) - sd(outcome), noise-corrected | `all states` | as traced | -0.0578 | -0.0398 | **-0.0180** | [-0.0377, +0.0019] | 2000 | **NOT DETECTED** (CI covers zero) |
| own-team leave-one-battle-out win-rate R^2 of V ⭐ | `turn 1` | MATCHED 397/188/4 | +0.0359 | +0.0386 | **-0.0027** | [-0.0193, +0.0135] | 2000 | **NOT DETECTED** (CI covers zero) |
| own-team leave-one-battle-out win-rate R^2 of V | `all states` | MATCHED 397/188/4 | +0.0042 | +0.0062 | **-0.0020** | [-0.0077, +0.0035] | 2000 | **NOT DETECTED** (CI covers zero) |
...
| WITHIN-own-team Murphy resolution of V (cells >= MIN_TEAM_BATTLES battles, battle-weighted over teams) | `all states, <=2 per battle` | MATCHED 397/188/4 | +0.0605 | +0.0594 | **+0.0012** | [-0.0063, +0.0059] | 2000 | **NOT DETECTED** (CI covers zero) |
| the same resolution WITHIN team-STRENGTH strata (quantiles of the team's LOO win rate) | `all states, <=2 per battle` | MATCHED 397/188/4 | +0.0376 | +0.0303 | **+0.0073** | [+0.0019, +0.0122] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| the same ratio UNCORRECTED and unclamped | `turn 1-3` | MATCHED 397/188/4 | +0.3166 | +0.5735 | **-0.2568** | [-0.2468, -0.1645] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| own-team leave-one-battle-out win-rate R^2 of V | `turn >= 25` | MATCHED 397/188/4 | -0.0023 | +0.0005 | **-0.0028** | [-0.0103, +0.0044] | 2000 | **NOT DETECTED** (CI covers zero) |
...
|---|---|---|---|---|---|---|
| WITHIN-own-team Murphy resolution of V (cells >= MIN_TEAM_BATTLES battles, battle-weighted over teams) · `all states, <=2 per battle` | MATCHED 397/188/4 | +0.0605 | +0.0594 | **+0.0012** | [-0.0063, +0.0059] | **NOT DETECTED** (CI covers zero) |
| the same resolution WITHIN team-STRENGTH strata (quantiles of the team's LOO win rate) · `all states, <=2 per battle` | MATCHED 397/188/4 | +0.0376 | +0.0303 | **+0.0073** | [+0.0019, +0.0122] | **DETECTED** (vs ZERO — NO FLOOR) |
| own-team leave-one-battle-out win-rate R^2 of V · `turn 1` | MATCHED 397/188/4 | +0.0359 | +0.0386 | **-0.0027** | [-0.0193, +0.0135] | **NOT DETECTED** (CI covers zero) |
| own-team leave-one-battle-out win-rate R^2 of V · `turn >= 25` | MATCHED 397/188/4 | -0.0023 | +0.0005 | **-0.0028** | [-0.0103, +0.0044] | **NOT DETECTED** (CI covers zero) |
...
| row | frame | arm | control | **Δ** | 95% CI | verdict |
|---|---|---|---|---|---|---|
| `cond.spread_ratio_raw.t1_3` | MATCHED · battle 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.0570 [+0.0564, +0.0577] | +0.1803 | **-0.1233** | [-0.1597, -0.0905] | **DETECTED** (vs ZERO — NO FLOOR) |
| `cond.spread_ratio_raw.t1_3` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.0570 [+0.0564, +0.0577] | +0.1804 | **-0.1235** | [-0.1591, -0.0906] | **DETECTED** (vs ZERO — NO FLOOR) |
| `cond.spread_ratio_raw.t1_3` | UNMATCHED (as traced) | +0.0572 | +0.1804 | **-0.1233** | [-0.1592, -0.0903] | *no label — not a reading* |
| `cond.spread_ratio_raw.all` | MATCHED · battle 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.5486 [+0.5465, +0.5499] | +0.6644 | **-0.1159** | [-0.2277, -0.0114] | **DETECTED** (vs ZERO — NO FLOOR) |
| `cond.spread_ratio_raw.all` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.5486 [+0.5465, +0.5499] | +0.6644 | **-0.1159** | [-0.2281, -0.0078] | **DETECTED** (vs ZERO — NO FLOOR) |
| `cond.spread_ratio_raw.all` | UNMATCHED (as traced) | +0.5487 | +0.6644 | **-0.1157** | [-0.2226, -0.0084] | *no label — not a reading* |
| `cond.own_team_r2.t1` | MATCHED · battle 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.0359 [+0.0343, +0.0380] | +0.0386 | **-0.0027** | [-0.0193, +0.0135] | **NOT DETECTED** (CI covers zero) |
| `cond.own_team_r2.t1` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.0359 [+0.0343, +0.0380] | +0.0376 | **-0.0017** | [-0.0181, +0.0144] | **NOT DETECTED** (CI covers zero) |
| `cond.own_team_r2.t1` | UNMATCHED (as traced) | +0.0368 | +0.0376 | **-0.0007** | [-0.0169, +0.0155] | *no label — not a reading* |
| `cond.own_team_r2.all` | MATCHED · battle 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.0042 [+0.0036, +0.0048] | +0.0062 | **-0.0020** | [-0.0077, +0.0035] | **NOT DETECTED** (CI covers zero) |
| `cond.own_team_r2.all` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.0042 [+0.0036, +0.0048] | +0.0048 | **-0.0006** | [-0.0066, +0.0047] | **NOT DETECTED** (CI covers zero) |
...
| `cond.opp_class_auc.t1` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.5082 [+0.5044, +0.5107] | +0.5137 | **-0.0055** | [-0.0317, +0.0201] | **NOT DETECTED** (CI covers zero) |
| `cond.opp_class_auc.t1` | UNMATCHED (as traced) | +0.5062 | +0.5137 | **-0.0075** | [-0.0342, +0.0185] | *no label — not a reading* |
| `cond.within_team_resolution.all` | MATCHED · battle 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.0605 [+0.0599, +0.0613] | +0.0594 | **+0.0012** | [-0.0063, +0.0059] | **NOT DETECTED** (CI covers zero) |
| `cond.within_team_resolution.all` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.0605 [+0.0599, +0.0613] | +0.0595 | **+0.0011** | [-0.0061, +0.0059] | **NOT DETECTED** (CI covers zero) |
| `cond.within_team_resolution.all` | UNMATCHED (as traced) | +0.0606 | +0.0595 | **+0.0012** | [-0.0062, +0.0064] | *no label — not a reading* |
| `cond.within_stratum_resolution.all` | MATCHED · battle 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.0376 [+0.0365, +0.0380] | +0.0303 | **+0.0073** | [+0.0019, +0.0122] | **DETECTED** (vs ZERO — NO FLOOR) |
| `cond.within_stratum_resolution.all` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.0376 [+0.0365, +0.0380] | +0.0305 | **+0.0071** | [+0.0019, +0.0120] | **DETECTED** (vs ZERO — NO FLOOR) |
| `cond.within_stratum_resolution.all` | UNMATCHED (as traced) | +0.0385 | +0.0305 | **+0.0080** | [+0.0024, +0.0131] | *no label — not a reading* |
| `cond.team_spread_ratio_raw.t1_3` | MATCHED · battle 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.3166 [+0.3159, +0.3205] | +0.5735 | **-0.2568** | [-0.2468, -0.1645] | **DETECTED** (vs ZERO — NO FLOOR) |
| `cond.team_spread_ratio_raw.t1_3` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.3166 [+0.3159, +0.3205] | +0.5732 | **-0.2566** | [-0.2469, -0.1632] | **DETECTED** (vs ZERO — NO FLOOR) |
| `cond.team_spread_ratio_raw.t1_3` | UNMATCHED (as traced) | +0.3169 | +0.5732 | **-0.2563** | [-0.2469, -0.1610] | *no label — not a reading* |
| `cond.own_team_r2.late` | MATCHED · battle 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | -0.0023 [-0.0035, -0.0008] | +0.0005 | **-0.0028** | [-0.0103, +0.0044] | **NOT DETECTED** (CI covers zero) |
| `cond.own_team_r2.late` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | -0.0023 [-0.0035, -0.0008] | +0.0028 | **-0.0051** | [-0.0114, +0.0016] | **NOT DETECTED** (CI covers zero) |
...
```
ai_v12_19_ladder_lambda09 vs ai_v12_11_ladder_ctrl10M at 10M [OFFLINE-GENERATED: 400 games x 9+3 opponents, full capture]: G1 bot Δ +0.0023 [-0.0044, +0.0091] NOT DETECTED · identity bias late Δ +0.0124 [-0.0365, +0.0639] NOT DETECTED · turn-contrast Δ -0.1246 [-0.2787, +0.0314] NOT DETECTED · spread ratio t1-3 Δ -0.1236 [-0.1607, -0.0895] DETECTED · own-team R2 t1 Δ -0.0027 [-0.0193, +0.0135] NOT DETECTED [QUOTA-MATCHED] · calib slope Δ +0.3079 [+0.2037, +0.4159] DETECTED
```
...
python -m main.ops.critic_read ai_v12_19_ladder_lambda09 --control ai_v12_11_ladder_ctrl10M --step 10000032 --arm-traces /home/goodlad/.claude/jobs/9ab51de6/tmp/hp_eval/ai_v12_19_ladder_lambda09 --control-traces /home/goodlad/.claude/jobs/9ab51de6/tmp/hp_eval/ai_v12_11_ladder_ctrl10M --out /home/goodlad/.claude/jobs/9ab51de6/tmp/hp_eval/reads/v5_lambda400 --nice 15
...
| this report | `/home/goodlad/.claude/jobs/9ab51de6/tmp/hp_eval/reads/v5_lambda400/critic_read.md` |
| machine-readable | `/home/goodlad/.claude/jobs/9ab51de6/tmp/hp_eval/reads/v5_lambda400/critic_read.json` |
