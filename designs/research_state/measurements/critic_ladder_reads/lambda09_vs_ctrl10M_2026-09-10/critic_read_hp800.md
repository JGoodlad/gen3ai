...
The critic ladder's registered read (ledger 2026-09-08 *REGISTRATION · THE CRITIC LADDER*), produced by `python -m main.ops.critic_read` v4 at 2026-09-10T09:47:57. Every number is a DELTA, **arm − control**, with the difference of the two runs' independent battle-clustered bootstraps. Strength is NOT read.
...
|---|---|---|---|---|---|---|
| resolution · `bot` | — | +0.0265 | +0.0170 | **+0.0095** | [+0.0049, +0.0148] | **DETECTED** (CI clears the floor +0.0036) |
| bias V - p_hat · `late (turn>=25)` | — | +0.0203 | -0.0189 | **+0.0392** | [-0.0040, +0.0828] | **WITHIN FLOOR** (|delta| <= floor 0.0681) |
| corr(turn,V) - corr(turn,MC) · `ALL` | — | -0.0609 | +0.0386 | **-0.0995** | [-0.2155, +0.0148] | **WITHIN FLOOR** (|delta| <= floor 0.1082) |
| skill · `bot` | — | +0.2546 | +0.1237 | **+0.1309** | [+0.0872, +0.1874] | **NOT DETECTED** (CI does not clear the floor 0.1004) |
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected · `turn 1-3` | as traced | +0.0475 | +0.1454 | **-0.0979** | [-0.1228, -0.0744] | **DETECTED** (CI clears the floor +0.0426) |
| own-team leave-one-battle-out win-rate R^2 of V · `turn 1` | MATCHED 797/348/6 | +0.0616 | +0.0463 | **+0.0153** | [+0.0017, +0.0284] | **NOT DETECTED** (CI does not clear the floor 0.0037) |
...
|---|---|---|---|---|---|---|---|---|
| resolution ⭐ | `all` | `capture-rate (gauge)` | +0.0474 | +0.0386 | **+0.0088** | [+0.0031, +0.0149] | 400 | **DETECTED** (CI clears the floor +0.0002) |
| resolution ⭐ | `bot` | `capture-rate (gauge)` | +0.0265 | +0.0170 | **+0.0095** | [+0.0049, +0.0148] | 400 | **DETECTED** (CI clears the floor +0.0036) |
| resolution ⭐ | `pool` | `capture-rate (gauge)` | +0.0682 | +0.0614 | **+0.0068** | [-0.0026, +0.0181] | 400 | **WITHIN FLOOR** (|delta| <= floor 0.0086) |
| reliability | `all` | `capture-rate (gauge)` | +0.0013 | +0.0010 | **+0.0003** | [-0.0006, +0.0014] | 400 | **WITHIN FLOOR** (|delta| <= floor 0.0021) |
| reliability | `bot` | `capture-rate (gauge)` | +0.0005 | +0.0053 | **-0.0047** | [-0.0065, -0.0034] | 400 | **NOT DETECTED** (CI does not clear the floor 0.0047) |
| reliability | `pool` | `capture-rate (gauge)` | +0.0078 | +0.0019 | **+0.0059** | [+0.0020, +0.0102] | 400 | **WITHIN FLOOR** (|delta| <= floor 0.0167) |
| ece | `all` | `capture-rate (gauge)` | +0.0225 | +0.0237 | **-0.0012** | [-0.0093, +0.0087] | 400 | **WITHIN FLOOR** (|delta| <= floor 0.0122) |
| ece | `bot` | `capture-rate (gauge)` | +0.0202 | +0.0445 | **-0.0243** | [-0.0356, -0.0161] | 400 | **WITHIN FLOOR** (|delta| <= floor 0.0297) |
| ece | `pool` | `capture-rate (gauge)` | +0.0713 | +0.0403 | **+0.0311** | [+0.0079, +0.0519] | 400 | **WITHIN FLOOR** (|delta| <= floor 0.0822) |
| skill ⭐ | `all` | `capture-rate (gauge)` | +0.3122 | +0.2598 | **+0.0524** | [+0.0234, +0.0859] | 400 | **DETECTED** (CI clears the floor +0.0071) |
| skill ⭐ | `bot` | `capture-rate (gauge)` | +0.2546 | +0.1237 | **+0.1309** | [+0.0872, +0.1874] | 400 | **NOT DETECTED** (CI does not clear the floor 0.1004) |
| skill ⭐ | `pool` | `capture-rate (gauge)` | +0.2855 | +0.2742 | **+0.0113** | [-0.0288, +0.0556] | 400 | **WITHIN FLOOR** (|delta| <= floor 0.1108) |

## 2. IDENTITY — V against the Monte-Carlo continuation

| quantity | stratum | weighting | arm | control | **Δ** | 95% CI | n draws | verdict |
|---|---|---|---|---|---|---|---|---|
| bias V - p_hat | `ALL` | `raw` | +0.0534 | +0.0164 | **+0.0370** | [+0.0110, +0.0641] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0829) |
| bias V - p_hat | `ALL` | `pop` | +0.0045 | -0.0363 | **+0.0407** | [+0.0205, +0.0617] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0681) |
| bias V - p_hat ⭐ | `ALL` | `ipw` | +0.0045 | -0.0363 | **+0.0407** | [+0.0205, +0.0617] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0681) |
| bias V - p_hat | `early (turn<=10)` | `raw` | +0.0459 | -0.0107 | **+0.0566** | [+0.0150, +0.0972] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0948) |
| bias V - p_hat | `early (turn<=10)` | `pop` | -0.0070 | -0.0648 | **+0.0577** | [+0.0239, +0.0921] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0765) |
| bias V - p_hat ⭐ | `early (turn<=10)` | `ipw` | -0.0070 | -0.0648 | **+0.0577** | [+0.0239, +0.0921] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0765) |
| bias V - p_hat | `mid (11-24)` | `raw` | +0.0462 | +0.0229 | **+0.0234** | [-0.0131, +0.0622] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0748) |
| bias V - p_hat | `mid (11-24)` | `pop` | +0.0056 | -0.0195 | **+0.0251** | [-0.0046, +0.0561] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0556) |
| bias V - p_hat ⭐ | `mid (11-24)` | `ipw` | +0.0056 | -0.0195 | **+0.0251** | [-0.0046, +0.0561] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0556) |
| bias V - p_hat | `late (turn>=25)` | `raw` | +0.0740 | +0.0411 | **+0.0330** | [-0.0230, +0.0880] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0821) |
| bias V - p_hat | `late (turn>=25)` | `pop` | +0.0203 | -0.0189 | **+0.0392** | [-0.0040, +0.0828] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0681) |
| bias V - p_hat ⭐ | `late (turn>=25)` | `ipw` | +0.0203 | -0.0189 | **+0.0392** | [-0.0040, +0.0828] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0681) |
| bias V - p_hat | `bot` | `raw` | +0.0329 | +0.0029 | **+0.0300** | [-0.0013, +0.0615] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0575) |
| bias V - p_hat | `bot` | `pop` | -0.0137 | -0.0441 | **+0.0304** | [+0.0089, +0.0523] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0417) |
| bias V - p_hat ⭐ | `bot` | `ipw` | -0.0137 | -0.0441 | **+0.0304** | [+0.0089, +0.0523] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0417) |
| bias V - p_hat | `pool` | `raw` | +0.0921 | +0.0436 | **+0.0486** | [-0.0000, +0.0960] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.1164) |
| bias V - p_hat | `pool` | `pop` | +0.0311 | -0.0190 | **+0.0501** | [+0.0078, +0.0928] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.1196) |
| bias V - p_hat ⭐ | `pool` | `ipw` | +0.0311 | -0.0190 | **+0.0501** | [+0.0078, +0.0928] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.1196) |
...
| Murphy skill_score | `ALL` | `raw` | +0.1972 | +0.1626 | **+0.0346** | [-0.0360, +0.1049] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0370) |
...
| Murphy reliability | `ALL` | `raw` | +0.0056 | +0.0024 | **+0.0032** | [-0.0012, +0.0076] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0119) |
...
| corr(turn,V) - corr(turn,MC) ⭐ | `ALL` | `raw` | -0.0609 | +0.0386 | **-0.0995** | [-0.2155, +0.0148] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.1082) |
| corr(turn,V) - corr(turn,MC) | `ALL` | `pop` | -0.0302 | +0.0222 | **-0.0524** | [-0.1516, +0.0538] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0984) |
| corr(turn,V) - corr(turn,MC) | `ALL` | `ipw` | -0.0302 | +0.0222 | **-0.0524** | [-0.1516, +0.0538] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0984) |
...
|---|---|---|---|---|---|---|---|---|
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected ⭐ | `turn 1-3` | as traced | +0.0475 | +0.1454 | **-0.0979** | [-0.1228, -0.0744] | 2000 | **DETECTED** (CI clears the floor +0.0426) |
| the same ratio UNCORRECTED and unclamped | `turn 1-3` | MATCHED 797/348/6 | +0.0500 | +0.1478 | **-0.0978** | [-0.1215, -0.0757] | 2000 | **DETECTED** (CI clears the floor +0.0448) |
| sd(V) - sd(outcome), noise-corrected | `turn 1-3` | as traced | -0.1129 | -0.1018 | **-0.0111** | [-0.0242, +0.0025] | 2000 | **NOT DETECTED** (CI covers zero) |
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected | `all states` | as traced | +0.5598 | +0.6237 | **-0.0639** | [-0.1412, +0.0193] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.1973) |
| the same ratio UNCORRECTED and unclamped | `all states` | MATCHED 797/348/6 | +0.5583 | +0.6232 | **-0.0649** | [-0.1434, +0.0131] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.1969) |
| sd(V) - sd(outcome), noise-corrected | `all states` | as traced | -0.0522 | -0.0448 | **-0.0073** | [-0.0214, +0.0072] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.0218) |
| own-team leave-one-battle-out win-rate R^2 of V ⭐ | `turn 1` | MATCHED 797/348/6 | +0.0616 | +0.0463 | **+0.0153** | [+0.0017, +0.0284] | 2000 | **NOT DETECTED** (CI does not clear the floor 0.0037) |
...
| WITHIN-own-team Murphy resolution of V (cells >= MIN_TEAM_BATTLES battles, battle-weighted over teams) | `all states, <=2 per battle` | MATCHED 797/348/6 | +0.0550 | +0.0536 | **+0.0014** | [-0.0043, +0.0038] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.0044) |
| the same resolution WITHIN team-STRENGTH strata (quantiles of the team's LOO win rate) | `all states, <=2 per battle` | MATCHED 797/348/6 | +0.0353 | +0.0312 | **+0.0041** | [+0.0005, +0.0077] | 2000 | **DETECTED** (CI clears the floor +0.0002) |
| BETWEEN-team spread ratio sd(mean V) / sd(team win rate), noise-corrected | `turn 1-3` | MATCHED 797/348/6 | +0.9584 | +1.2453 | **-0.2869** | [-0.3699, -0.1878] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.4324) |
| the same ratio UNCORRECTED and unclamped | `turn 1-3` | MATCHED 797/348/6 | +0.4005 | +0.6762 | **-0.2757** | [-0.2704, -0.1885] | 2000 | **NOT DETECTED** (CI does not clear the floor 0.2507) |
| own-team leave-one-battle-out win-rate R^2 of V | `turn >= 25` | MATCHED 797/348/6 | +0.0039 | +0.0043 | **-0.0005** | [-0.0067, +0.0058] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.0012) |
...
|---|---|---|---|---|---|---|
| WITHIN-own-team Murphy resolution of V (cells >= MIN_TEAM_BATTLES battles, battle-weighted over teams) · `all states, <=2 per battle` | MATCHED 797/348/6 | +0.0550 | +0.0536 | **+0.0014** | [-0.0043, +0.0038] | **WITHIN FLOOR** (|delta| <= floor 0.0044) |
| the same resolution WITHIN team-STRENGTH strata (quantiles of the team's LOO win rate) · `all states, <=2 per battle` | MATCHED 797/348/6 | +0.0353 | +0.0312 | **+0.0041** | [+0.0005, +0.0077] | **DETECTED** (CI clears the floor +0.0002) |
| BETWEEN-team spread ratio sd(mean V) / sd(team win rate), noise-corrected · `turn 1-3` | MATCHED 797/348/6 | +0.9584 | +1.2453 | **-0.2869** | [-0.3699, -0.1878] | **WITHIN FLOOR** (|delta| <= floor 0.4324) |
| own-team leave-one-battle-out win-rate R^2 of V · `turn 1` | MATCHED 797/348/6 | +0.0616 | +0.0463 | **+0.0153** | [+0.0017, +0.0284] | **NOT DETECTED** (CI does not clear the floor 0.0037) |
| own-team leave-one-battle-out win-rate R^2 of V · `turn >= 25` | MATCHED 797/348/6 | +0.0039 | +0.0043 | **-0.0005** | [-0.0067, +0.0058] | **WITHIN FLOOR** (|delta| <= floor 0.0012) |
...
| row | frame | arm | control | **Δ** | 95% CI | verdict |
|---|---|---|---|---|---|---|
| `cond.spread_ratio_raw.t1_3` | MATCHED · battle 797/348/6 (9537 battles, 9531 decoder battles, 21 seeds) | +0.0500 [+0.1466, +0.1490] | +0.1478 | **-0.0978** | [-0.1215, -0.0757] | **DETECTED** (CI clears the floor +0.0448) |
| `cond.spread_ratio_raw.t1_3` | MATCHED · decoder 897/392/6 (9557 battles, 9551 decoder battles, 21 seeds) | +0.0500 [+0.1477, +0.1477] | +0.1477 | **-0.0978** | [-0.1223, -0.0750] | **DETECTED** (CI clears the floor +0.0448) |
| `cond.spread_ratio_raw.t1_3` | UNMATCHED (as traced) | +0.0500 | +0.1477 | **-0.0978** | [-0.1223, -0.0750] | *no label — not a reading* |
| `cond.spread_ratio_raw.all` | MATCHED · battle 797/348/6 (9537 battles, 9531 decoder battles, 21 seeds) | +0.5583 [+0.6188, +0.6262] | +0.6232 | **-0.0649** | [-0.1434, +0.0131] | **WITHIN FLOOR** (|delta| <= floor 0.1969) |
| `cond.spread_ratio_raw.all` | MATCHED · decoder 897/392/6 (9557 battles, 9551 decoder battles, 21 seeds) | +0.5583 [+0.6221, +0.6221] | +0.6221 | **-0.0638** | [-0.1402, +0.0186] | **WITHIN FLOOR** (|delta| <= floor 0.1969) |
| `cond.spread_ratio_raw.all` | UNMATCHED (as traced) | +0.5583 | +0.6221 | **-0.0638** | [-0.1402, +0.0186] | *no label — not a reading* |
| `cond.own_team_r2.t1` | MATCHED · battle 797/348/6 (9537 battles, 9531 decoder battles, 21 seeds) | +0.0616 [+0.0440, +0.0488] | +0.0463 | **+0.0153** | [+0.0017, +0.0284] | **NOT DETECTED** (CI does not clear the floor 0.0037) |
| `cond.own_team_r2.t1` | MATCHED · decoder 897/392/6 (9557 battles, 9551 decoder battles, 21 seeds) | +0.0616 [+0.0475, +0.0475] | +0.0475 | **+0.0141** | [+0.0007, +0.0277] | **NOT DETECTED** (CI does not clear the floor 0.0037) |
...
| `cond.within_team_resolution.all` | MATCHED · battle 797/348/6 (9537 battles, 9531 decoder battles, 21 seeds) | +0.0550 [+0.0531, +0.0543] | +0.0536 | **+0.0014** | [-0.0043, +0.0038] | **WITHIN FLOOR** (|delta| <= floor 0.0044) |
| `cond.within_team_resolution.all` | MATCHED · decoder 897/392/6 (9557 battles, 9551 decoder battles, 21 seeds) | +0.0550 [+0.0531, +0.0531] | +0.0531 | **+0.0019** | [-0.0041, +0.0043] | **WITHIN FLOOR** (|delta| <= floor 0.0044) |
| `cond.within_team_resolution.all` | UNMATCHED (as traced) | +0.0550 | +0.0531 | **+0.0019** | [-0.0041, +0.0043] | *no label — not a reading* |
| `cond.within_stratum_resolution.all` | MATCHED · battle 797/348/6 (9537 battles, 9531 decoder battles, 21 seeds) | +0.0353 [+0.0309, +0.0319] | +0.0312 | **+0.0041** | [+0.0005, +0.0077] | **DETECTED** (CI clears the floor +0.0002) |
| `cond.within_stratum_resolution.all` | MATCHED · decoder 897/392/6 (9557 battles, 9551 decoder battles, 21 seeds) | +0.0353 [+0.0308, +0.0308] | +0.0308 | **+0.0045** | [+0.0009, +0.0084] | **DETECTED** (CI clears the floor +0.0002) |
| `cond.within_stratum_resolution.all` | UNMATCHED (as traced) | +0.0353 | +0.0308 | **+0.0045** | [+0.0009, +0.0084] | *no label — not a reading* |
| `cond.team_spread_ratio.t1_3` | MATCHED · battle 797/348/6 (9537 battles, 9531 decoder battles, 21 seeds) | +0.9584 [+1.2280, +1.2779] | +1.2453 | **-0.2869** | [-0.3699, -0.1878] | **WITHIN FLOOR** (|delta| <= floor 0.4324) |
| `cond.team_spread_ratio.t1_3` | MATCHED · decoder 897/392/6 (9557 battles, 9551 decoder battles, 21 seeds) | +0.9584 [+1.2523, +1.2523] | +1.2523 | **-0.2939** | [-0.3758, -0.1870] | **WITHIN FLOOR** (|delta| <= floor 0.4324) |
| `cond.team_spread_ratio.t1_3` | UNMATCHED (as traced) | +0.9584 | +1.2523 | **-0.2939** | [-0.3758, -0.1870] | *no label — not a reading* |
| `cond.team_spread_ratio_raw.t1_3` | MATCHED · battle 797/348/6 (9537 battles, 9531 decoder battles, 21 seeds) | +0.4005 [+0.6736, +0.6800] | +0.6762 | **-0.2757** | [-0.2704, -0.1885] | **NOT DETECTED** (CI does not clear the floor 0.2507) |
| `cond.team_spread_ratio_raw.t1_3` | MATCHED · decoder 897/392/6 (9557 battles, 9551 decoder battles, 21 seeds) | +0.4005 [+0.6791, +0.6791] | +0.6791 | **-0.2786** | [-0.2729, -0.1889] | **NOT DETECTED** (CI does not clear the floor 0.2507) |
| `cond.team_spread_ratio_raw.t1_3` | UNMATCHED (as traced) | +0.4005 | +0.6791 | **-0.2786** | [-0.2729, -0.1889] | *no label — not a reading* |
| `cond.own_team_r2.late` | MATCHED · battle 797/348/6 (9537 battles, 9531 decoder battles, 21 seeds) | +0.0039 [+0.0032, +0.0053] | +0.0043 | **-0.0005** | [-0.0067, +0.0058] | **WITHIN FLOOR** (|delta| <= floor 0.0012) |
...
```
ai_v12_19_ladder_lambda09 vs ai_v12_11_ladder_ctrl10M at 10M [OFFLINE-GENERATED: 800 games x 9+3 opponents, full capture]: G1 bot Δ +0.0095 [+0.0049, +0.0148] DETECTED · identity bias late Δ +0.0392 [-0.0040, +0.0828] WITHIN FLOOR · turn-contrast Δ -0.0995 [-0.2155, +0.0148] WITHIN FLOOR · spread ratio t1-3 Δ -0.0979 [-0.1228, -0.0744] DETECTED · own-team R2 t1 Δ +0.0153 [+0.0017, +0.0284] NOT DETECTED [QUOTA-MATCHED]
```
...
| this report | `/home/goodlad/.claude/jobs/9ab51de6/tmp/hp_eval/hp800/reads/ai_v12_19_ladder_lambda09_vs_ctrl10M/critic_read.md` |
| machine-readable | `/home/goodlad/.claude/jobs/9ab51de6/tmp/hp_eval/hp800/reads/ai_v12_19_ladder_lambda09_vs_ctrl10M/critic_read.json` |
