...
The critic ladder's registered read (ledger 2026-09-08 *REGISTRATION · THE CRITIC LADDER*), produced by `python -m main.ops.critic_read` v6 at 2026-09-11T12:56:30. Every number is a DELTA, **arm − control**, with the difference of the two runs' independent battle-clustered bootstraps. Strength is NOT read.
...
|---|---|---|---|---|---|---|
| resolution · `bot` | — | +0.0225 | +0.0202 | **+0.0023** | [-0.0044, +0.0091] | **WITHIN FLOOR** (|delta| <= floor 0.0024) |
...
| own-team leave-one-battle-out win-rate R^2 of V · `turn 1` | MATCHED 397/188/4 | +0.0359 | +0.0386 | **-0.0027** | [-0.0193, +0.0135] | **WITHIN FLOOR** (|delta| <= floor 0.0164) |
| calibration SLOPE — weighted logistic regression of the outcome on logit(V) (1 = correctly dispersed, >1 = SHRUNK, <1 = over-dispersed) · `all states, <=2 per battle` | as traced | +1.3798 | +1.0719 | **+0.3079** | [+0.2037, +0.4159] | **DETECTED** (vs ZERO — NO FLOOR) |
...
|---|---|---|---|---|---|---|---|---|
| resolution ⭐ | `all` | `capture-rate (gauge)` | +0.0495 | +0.0395 | **+0.0100** | [+0.0018, +0.0183] | 400 | **DETECTED** (CI clears the floor +0.0011) |
| resolution ⭐ | `bot` | `capture-rate (gauge)` | +0.0225 | +0.0202 | **+0.0023** | [-0.0044, +0.0091] | 400 | **WITHIN FLOOR** (|delta| <= floor 0.0024) |
...
| Murphy reliability | `ALL` | `pop` | +0.0011 | +0.0036 | **-0.0025** | [-0.0070, +0.0007] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0031) |
| Murphy reliability ⭐ | `ALL` | `ipw` | +0.0011 | +0.0036 | **-0.0025** | [-0.0070, +0.0007] | 4000 | **WITHIN FLOOR** (|delta| <= floor 0.0031) |
...
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected | `turn 4-10` | as traced | +0.3184 | +0.5451 | **-0.2267** | [-0.3101, -0.1474] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected | `turn 11-24` | as traced | +0.6257 | +0.7482 | **-0.1226** | [-0.2461, -0.0032] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| own-team leave-one-battle-out win-rate R^2 of V ⭐ | `turn 1` | MATCHED 397/188/4 | +0.0359 | +0.0386 | **-0.0027** | [-0.0193, +0.0135] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.0164) |
...
| opponent-CLASS (pool vs bot) AUC of V | `turn 1-3` | MATCHED 397/188/4 | +0.5630 | +0.6062 | **-0.0432** | [-0.0668, -0.0190] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| opponent-CLASS (pool vs bot) AUC of V | `turn 4-10` | MATCHED 397/188/4 | +0.7144 | +0.7152 | **-0.0008** | [-0.0208, +0.0201] | 2000 | **NOT DETECTED** (CI covers zero) |
| OPPONENT-DECODABLE between-opponent spread ratio — sum_o q(o|V)*p_o, noise-corrected (NOT a bound on the row above) | `turn 1-3` | MATCHED 397/188/4 | +0.0122 | +0.0273 | **-0.0152** | [-0.0209, -0.0094] | 2000 | **PROVISIONAL — no floor; never DETECTED** (a DESCRIPTIVE DECOMPOSITION TERM, never a pass/fail bar and never a treatment effect. It is the between-opponent spread ratio a head conditioning ONLY on WHICH OPPONENT its own `V` reveals would exhibit — `sum_o q(o|V)*p_o` — and it is read BESIDE `cond.spread_ratio.<window>` to split that row into an OPPONENT-IDENTITY part and a remainder. 🚨 IT IS NOT AN UPPER BOUND ON THAT ROW AND `V` ROUTINELY EXCEEDS IT: measured on the hp800 lambda09/ctrl10M pair, V reads 0.647 / 0.704 at turns 11-24 against this row's 0.214 / 0.187. A per-state conditional mean is an ATTENUATING transform, so the cell-mean spread of `E[p_o | V]` is smaller than the cell-mean spread of `V` itself; the excess is between-opponent spread that rides on BOARD STATE correlated with the opponent rather than on opponent identity. A delta between two sides is a difference in how much opponent IDENTITY each side's output carries; it is reported, and it is never DETECTED) |
| OPPONENT-DECODABLE between-opponent spread ratio — sum_o q(o|V)*p_o, noise-corrected (NOT a bound on the row above) | `turn 4-10` | MATCHED 397/188/4 | +0.1315 | +0.1349 | **-0.0034** | [-0.0261, +0.0199] | 2000 | **PROVISIONAL — no floor; never DETECTED** (a DESCRIPTIVE DECOMPOSITION TERM, never a pass/fail bar and never a treatment effect. It is the between-opponent spread ratio a head conditioning ONLY on WHICH OPPONENT its own `V` reveals would exhibit — `sum_o q(o|V)*p_o` — and it is read BESIDE `cond.spread_ratio.<window>` to split that row into an OPPONENT-IDENTITY part and a remainder. 🚨 IT IS NOT AN UPPER BOUND ON THAT ROW AND `V` ROUTINELY EXCEEDS IT: measured on the hp800 lambda09/ctrl10M pair, V reads 0.647 / 0.704 at turns 11-24 against this row's 0.214 / 0.187. A per-state conditional mean is an ATTENUATING transform, so the cell-mean spread of `E[p_o | V]` is smaller than the cell-mean spread of `V` itself; the excess is between-opponent spread that rides on BOARD STATE correlated with the opponent rather than on opponent identity. A delta between two sides is a difference in how much opponent IDENTITY each side's output carries; it is reported, and it is never DETECTED) |
| OPPONENT-DECODABLE between-opponent spread ratio — sum_o q(o|V)*p_o, noise-corrected (NOT a bound on the row above) | `turn 11-24` | MATCHED 397/188/4 | +0.2205 | +0.2012 | **+0.0193** | [-0.0155, +0.0545] | 2000 | **PROVISIONAL — no floor; never DETECTED** (a DESCRIPTIVE DECOMPOSITION TERM, never a pass/fail bar and never a treatment effect. It is the between-opponent spread ratio a head conditioning ONLY on WHICH OPPONENT its own `V` reveals would exhibit — `sum_o q(o|V)*p_o` — and it is read BESIDE `cond.spread_ratio.<window>` to split that row into an OPPONENT-IDENTITY part and a remainder. 🚨 IT IS NOT AN UPPER BOUND ON THAT ROW AND `V` ROUTINELY EXCEEDS IT: measured on the hp800 lambda09/ctrl10M pair, V reads 0.647 / 0.704 at turns 11-24 against this row's 0.214 / 0.187. A per-state conditional mean is an ATTENUATING transform, so the cell-mean spread of `E[p_o | V]` is smaller than the cell-mean spread of `V` itself; the excess is between-opponent spread that rides on BOARD STATE correlated with the opponent rather than on opponent identity. A delta between two sides is a difference in how much opponent IDENTITY each side's output carries; it is reported, and it is never DETECTED) |
| WITHIN-own-team Murphy resolution of V (cells >= MIN_TEAM_BATTLES battles, battle-weighted over teams) | `all states, <=2 per battle` | MATCHED 397/188/4 | +0.0605 | +0.0594 | **+0.0012** | [-0.0063, +0.0059] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.0056) |
| the same resolution WITHIN team-STRENGTH strata (quantiles of the team's LOO win rate) | `all states, <=2 per battle` | MATCHED 397/188/4 | +0.0376 | +0.0303 | **+0.0073** | [+0.0019, +0.0122] | 2000 | **NOT DETECTED** (CI does not clear the floor 0.0028) |
| the same ratio UNCORRECTED and unclamped | `turn 1-3` | MATCHED 397/188/4 | +0.3166 | +0.5735 | **-0.2568** | [-0.2468, -0.1645] | 2000 | **NOT DETECTED** (CI does not clear the floor 0.2470) |
| own-team leave-one-battle-out win-rate R^2 of V | `turn >= 25` | MATCHED 397/188/4 | -0.0023 | +0.0005 | **-0.0028** | [-0.0103, +0.0044] | 2000 | **WITHIN FLOOR** (|delta| <= floor 0.0057) |
| own-team R^2 at turn 1 MINUS own-team R^2 late | `turn 1 - turn >= 25` | MATCHED 397/188/4 | +0.0382 | +0.0378 | **+0.0003** | [-0.0158, +0.0176] | 2000 | **PROVISIONAL — no floor; never DETECTED** (NO FLOOR EXISTS FOR THIS ROW AND THE CONTROLS CANNOT SUPPLY ONE — every control reads own-team R^2 ~= 0 at turn 1, so there is nothing for it to FALL from and the two-draw replicate floor cannot be formed. The first replicate arm supplies it. A LARGE move either way is informative; a small one is not; and this row is never DETECTED) |
| calibration SLOPE — weighted logistic regression of the outcome on logit(V) (1 = correctly dispersed, >1 = SHRUNK, <1 = over-dispersed) | `all states, <=2 per battle` | as traced | +1.3798 | +1.0719 | **+0.3079** | [+0.2037, +0.4159] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| calibration-in-the-large — the INTERCEPT of that regression (0 = calibrated) | `all states, <=2 per battle` | as traced | -0.3383 | +0.4257 | **-0.7640** | [-0.9449, -0.5857] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| calibration SLOPE — weighted logistic regression of the outcome on logit(V) | `turn 1-3, <=2 per battle` | as traced | +1.1480 | +0.8379 | **+0.3101** | [+0.1179, +0.5144] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| calibration-in-the-large — the INTERCEPT of that regression | `turn 1-3, <=2 per battle` | as traced | -0.0229 | +0.9122 | **-0.9351** | [-1.2663, -0.6378] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| calibration SLOPE with a free intercept PER own-team STRENGTH STRATUM — the dispersion reading INSIDE a stratum rather than across teams | `all states, <=2 per battle, stratum fixed effects` | MATCHED 397/188/4 | +1.3503 | +1.0097 | **+0.3406** | [+0.2238, +0.4677] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| calibration SLOPE on the COMMON SUPPORT — both sides restricted to the intersection of their central 95% of V, so the lever arm sd(logit V) cannot differ between them | `all states, <=2 per battle, common V window` | as traced | +1.4063 | +1.0469 | **+0.3594** | [+0.2386, +0.4761] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| calibration-in-the-large on the COMMON SUPPORT | `all states, <=2 per battle, common V window` | as traced | -0.3807 | +0.4574 | **-0.8381** | [-1.0322, -0.6386] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
...
|---|---|---|---|---|
| arm `ai_v12_19_ladder_lambda09` | `t1_3` | +0.0538 | +0.0121 | 4.448 |
| arm `ai_v12_19_ladder_lambda09` | `t4_10` | +0.3184 | +0.1310 | 2.430 |
| arm `ai_v12_19_ladder_lambda09` | `t11_24` | +0.6257 | +0.2205 | 2.838 |
...
|---|---|---|---|---|---|---|
| WITHIN-own-team Murphy resolution of V (cells >= MIN_TEAM_BATTLES battles, battle-weighted over teams) · `all states, <=2 per battle` | MATCHED 397/188/4 | +0.0605 | +0.0594 | **+0.0012** | [-0.0063, +0.0059] | **WITHIN FLOOR** (|delta| <= floor 0.0056) |
| the same resolution WITHIN team-STRENGTH strata (quantiles of the team's LOO win rate) · `all states, <=2 per battle` | MATCHED 397/188/4 | +0.0376 | +0.0303 | **+0.0073** | [+0.0019, +0.0122] | **NOT DETECTED** (CI does not clear the floor 0.0028) |
| own-team leave-one-battle-out win-rate R^2 of V · `turn 1` | MATCHED 397/188/4 | +0.0359 | +0.0386 | **-0.0027** | [-0.0193, +0.0135] | **WITHIN FLOOR** (|delta| <= floor 0.0164) |
| own-team leave-one-battle-out win-rate R^2 of V · `turn >= 25` | MATCHED 397/188/4 | -0.0023 | +0.0005 | **-0.0028** | [-0.0103, +0.0044] | **WITHIN FLOOR** (|delta| <= floor 0.0057) |
| own-team R^2 at turn 1 MINUS own-team R^2 late · `turn 1 - turn >= 25` | MATCHED 397/188/4 | +0.0382 | +0.0378 | **+0.0003** | [-0.0158, +0.0176] | **PROVISIONAL — no floor; never DETECTED** (NO FLOOR EXISTS FOR THIS ROW AND THE CONTROLS CANNOT SUPPLY ONE — every control reads own-team R^2 ~= 0 at turn 1, so there is nothing for it to FALL from and the two-draw replicate floor cannot be formed. The first replicate arm supplies it. A LARGE move either way is informative; a small one is not; and this row is never DETECTED) |
...
| arm · common support | `common support` | 9094 | 4734 | 0.8654 | **0.1335** | **1.2948** | [0.455, 0.994] | 0.0000 |
...
| control · common support | `common support` | 8978 | 4700 | 0.8380 | **0.1587** | **1.4750** | [0.395, 0.995] | 0.0000 |

The COMMON-SUPPORT window is `V ∈ [0.2536, 0.9962]` — the intersection of the two sides' central 95% of `V`. Both sides are re-fitted inside it, so the lever arm cannot differ between them and a surviving slope difference is not the support.

| row | frame | arm | control | **Δ** | 95% CI | replicate floor | verdict |
|---|---|---|---|---|---|---|---|
| calibration SLOPE · `all states, <=2 per battle` | as traced | +1.3798 | +1.0719 | **+0.3079** | [+0.2037, +0.4159] | — | **DETECTED** (vs ZERO — NO FLOOR) |
| calibration-in-the-large · `all states, <=2 per battle` | as traced | -0.3383 | +0.4257 | **-0.7640** | [-0.9449, -0.5857] | — | **DETECTED** (vs ZERO — NO FLOOR) |
| calibration SLOPE · `turn 1-3, <=2 per battle` | as traced | +1.1480 | +0.8379 | **+0.3101** | [+0.1179, +0.5144] | — | **DETECTED** (vs ZERO — NO FLOOR) |
| calibration-in-the-large · `turn 1-3, <=2 per battle` | as traced | -0.0229 | +0.9122 | **-0.9351** | [-1.2663, -0.6378] | — | **DETECTED** (vs ZERO — NO FLOOR) |
| calibration SLOPE with a free intercept PER own-team STRENGTH STRATUM · `all states, <=2 per battle, stratum fixed effects` | MATCHED 397/188/4 | +1.3503 | +1.0097 | **+0.3406** | [+0.2238, +0.4677] | — | **DETECTED** (vs ZERO — NO FLOOR) |
| calibration SLOPE on the COMMON SUPPORT · `all states, <=2 per battle, common V window` | as traced | +1.4063 | +1.0469 | **+0.3594** | [+0.2386, +0.4761] | — | **DETECTED** (vs ZERO — NO FLOOR) |
| calibration-in-the-large on the COMMON SUPPORT · `all states, <=2 per battle, common V window` | as traced | -0.3807 | +0.4574 | **-0.8381** | [-1.0322, -0.6386] | — | **DETECTED** (vs ZERO — NO FLOOR) |
...
| `cond.own_team_r2.t1` | MATCHED · battle 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.0359 [+0.0343, +0.0380] | +0.0386 | **-0.0027** | [-0.0193, +0.0135] | **WITHIN FLOOR** (|delta| <= floor 0.0164) |
| `cond.own_team_r2.t1` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.0359 [+0.0343, +0.0380] | +0.0376 | **-0.0017** | [-0.0181, +0.0144] | **WITHIN FLOOR** (|delta| <= floor 0.0164) |
...
| `cond.opp_class_auc.t1` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.5082 [+0.5044, +0.5107] | +0.5137 | **-0.0055** | [-0.0317, +0.0201] | **WITHIN FLOOR** (|delta| <= floor 0.0118) |
| `cond.opp_class_auc.t1` | UNMATCHED (as traced) | +0.5062 | +0.5137 | **-0.0075** | [-0.0342, +0.0185] | *no label — not a reading* |
| `cond.opp_class_auc.t1_3` | MATCHED · battle 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.5630 [+0.5620, +0.5642] | +0.6062 | **-0.0432** | [-0.0668, -0.0190] | **DETECTED** (vs ZERO — NO FLOOR) |
| `cond.opp_class_auc.t1_3` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.5630 [+0.5620, +0.5642] | +0.6005 | **-0.0375** | [-0.0610, -0.0153] | **DETECTED** (vs ZERO — NO FLOOR) |
| `cond.opp_class_auc.t1_3` | UNMATCHED (as traced) | +0.5592 | +0.6005 | **-0.0413** | [-0.0644, -0.0179] | *no label — not a reading* |
| `cond.opp_class_auc.t4_10` | MATCHED · battle 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.7144 [+0.7129, +0.7168] | +0.7152 | **-0.0008** | [-0.0208, +0.0201] | **NOT DETECTED** (CI covers zero) |
| `cond.opp_class_auc.t4_10` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.7144 [+0.7129, +0.7168] | +0.7169 | **-0.0025** | [-0.0233, +0.0181] | **NOT DETECTED** (CI covers zero) |
| `cond.opp_class_auc.t4_10` | UNMATCHED (as traced) | +0.7179 | +0.7169 | **+0.0010** | [-0.0195, +0.0202] | *no label — not a reading* |
| `cond.spread_ratio_optimal.t1_3` | MATCHED · battle 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.0122 [+0.0118, +0.0125] | +0.0273 | **-0.0152** | [-0.0209, -0.0094] | **PROVISIONAL — no floor; never DETECTED** (a DESCRIPTIVE DECOMPOSITION TERM, never a pass/fail bar and never a treatment effect. It is the between-opponent spread ratio a head conditioning ONLY on WHICH OPPONENT its own `V` reveals would exhibit — `sum_o q(o|V)*p_o` — and it is read BESIDE `cond.spread_ratio.<window>` to split that row into an OPPONENT-IDENTITY part and a remainder. 🚨 IT IS NOT AN UPPER BOUND ON THAT ROW AND `V` ROUTINELY EXCEEDS IT: measured on the hp800 lambda09/ctrl10M pair, V reads 0.647 / 0.704 at turns 11-24 against this row's 0.214 / 0.187. A per-state conditional mean is an ATTENUATING transform, so the cell-mean spread of `E[p_o | V]` is smaller than the cell-mean spread of `V` itself; the excess is between-opponent spread that rides on BOARD STATE correlated with the opponent rather than on opponent identity. A delta between two sides is a difference in how much opponent IDENTITY each side's output carries; it is reported, and it is never DETECTED) |
| `cond.spread_ratio_optimal.t1_3` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.0122 [+0.0118, +0.0125] | +0.0268 | **-0.0146** | [-0.0201, -0.0087] | **PROVISIONAL — no floor; never DETECTED** (a DESCRIPTIVE DECOMPOSITION TERM, never a pass/fail bar and never a treatment effect. It is the between-opponent spread ratio a head conditioning ONLY on WHICH OPPONENT its own `V` reveals would exhibit — `sum_o q(o|V)*p_o` — and it is read BESIDE `cond.spread_ratio.<window>` to split that row into an OPPONENT-IDENTITY part and a remainder. 🚨 IT IS NOT AN UPPER BOUND ON THAT ROW AND `V` ROUTINELY EXCEEDS IT: measured on the hp800 lambda09/ctrl10M pair, V reads 0.647 / 0.704 at turns 11-24 against this row's 0.214 / 0.187. A per-state conditional mean is an ATTENUATING transform, so the cell-mean spread of `E[p_o | V]` is smaller than the cell-mean spread of `V` itself; the excess is between-opponent spread that rides on BOARD STATE correlated with the opponent rather than on opponent identity. A delta between two sides is a difference in how much opponent IDENTITY each side's output carries; it is reported, and it is never DETECTED) |
| `cond.spread_ratio_optimal.t1_3` | UNMATCHED (as traced) | +0.0121 | +0.0268 | **-0.0147** | [-0.0206, -0.0089] | *no label — not a reading* |
| `cond.spread_ratio_optimal.t4_10` | MATCHED · battle 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.1315 [+0.1310, +0.1322] | +0.1349 | **-0.0034** | [-0.0261, +0.0199] | **PROVISIONAL — no floor; never DETECTED** (a DESCRIPTIVE DECOMPOSITION TERM, never a pass/fail bar and never a treatment effect. It is the between-opponent spread ratio a head conditioning ONLY on WHICH OPPONENT its own `V` reveals would exhibit — `sum_o q(o|V)*p_o` — and it is read BESIDE `cond.spread_ratio.<window>` to split that row into an OPPONENT-IDENTITY part and a remainder. 🚨 IT IS NOT AN UPPER BOUND ON THAT ROW AND `V` ROUTINELY EXCEEDS IT: measured on the hp800 lambda09/ctrl10M pair, V reads 0.647 / 0.704 at turns 11-24 against this row's 0.214 / 0.187. A per-state conditional mean is an ATTENUATING transform, so the cell-mean spread of `E[p_o | V]` is smaller than the cell-mean spread of `V` itself; the excess is between-opponent spread that rides on BOARD STATE correlated with the opponent rather than on opponent identity. A delta between two sides is a difference in how much opponent IDENTITY each side's output carries; it is reported, and it is never DETECTED) |
| `cond.spread_ratio_optimal.t4_10` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.1315 [+0.1310, +0.1322] | +0.1354 | **-0.0039** | [-0.0274, +0.0204] | **PROVISIONAL — no floor; never DETECTED** (a DESCRIPTIVE DECOMPOSITION TERM, never a pass/fail bar and never a treatment effect. It is the between-opponent spread ratio a head conditioning ONLY on WHICH OPPONENT its own `V` reveals would exhibit — `sum_o q(o|V)*p_o` — and it is read BESIDE `cond.spread_ratio.<window>` to split that row into an OPPONENT-IDENTITY part and a remainder. 🚨 IT IS NOT AN UPPER BOUND ON THAT ROW AND `V` ROUTINELY EXCEEDS IT: measured on the hp800 lambda09/ctrl10M pair, V reads 0.647 / 0.704 at turns 11-24 against this row's 0.214 / 0.187. A per-state conditional mean is an ATTENUATING transform, so the cell-mean spread of `E[p_o | V]` is smaller than the cell-mean spread of `V` itself; the excess is between-opponent spread that rides on BOARD STATE correlated with the opponent rather than on opponent identity. A delta between two sides is a difference in how much opponent IDENTITY each side's output carries; it is reported, and it is never DETECTED) |
| `cond.spread_ratio_optimal.t4_10` | UNMATCHED (as traced) | +0.1310 | +0.1354 | **-0.0044** | [-0.0271, +0.0182] | *no label — not a reading* |
| `cond.spread_ratio_optimal.t11_24` | MATCHED · battle 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.2205 [+0.2199, +0.2209] | +0.2012 | **+0.0193** | [-0.0155, +0.0545] | **PROVISIONAL — no floor; never DETECTED** (a DESCRIPTIVE DECOMPOSITION TERM, never a pass/fail bar and never a treatment effect. It is the between-opponent spread ratio a head conditioning ONLY on WHICH OPPONENT its own `V` reveals would exhibit — `sum_o q(o|V)*p_o` — and it is read BESIDE `cond.spread_ratio.<window>` to split that row into an OPPONENT-IDENTITY part and a remainder. 🚨 IT IS NOT AN UPPER BOUND ON THAT ROW AND `V` ROUTINELY EXCEEDS IT: measured on the hp800 lambda09/ctrl10M pair, V reads 0.647 / 0.704 at turns 11-24 against this row's 0.214 / 0.187. A per-state conditional mean is an ATTENUATING transform, so the cell-mean spread of `E[p_o | V]` is smaller than the cell-mean spread of `V` itself; the excess is between-opponent spread that rides on BOARD STATE correlated with the opponent rather than on opponent identity. A delta between two sides is a difference in how much opponent IDENTITY each side's output carries; it is reported, and it is never DETECTED) |
| `cond.spread_ratio_optimal.t11_24` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.2205 [+0.2199, +0.2209] | +0.2009 | **+0.0196** | [-0.0167, +0.0564] | **PROVISIONAL — no floor; never DETECTED** (a DESCRIPTIVE DECOMPOSITION TERM, never a pass/fail bar and never a treatment effect. It is the between-opponent spread ratio a head conditioning ONLY on WHICH OPPONENT its own `V` reveals would exhibit — `sum_o q(o|V)*p_o` — and it is read BESIDE `cond.spread_ratio.<window>` to split that row into an OPPONENT-IDENTITY part and a remainder. 🚨 IT IS NOT AN UPPER BOUND ON THAT ROW AND `V` ROUTINELY EXCEEDS IT: measured on the hp800 lambda09/ctrl10M pair, V reads 0.647 / 0.704 at turns 11-24 against this row's 0.214 / 0.187. A per-state conditional mean is an ATTENUATING transform, so the cell-mean spread of `E[p_o | V]` is smaller than the cell-mean spread of `V` itself; the excess is between-opponent spread that rides on BOARD STATE correlated with the opponent rather than on opponent identity. A delta between two sides is a difference in how much opponent IDENTITY each side's output carries; it is reported, and it is never DETECTED) |
| `cond.spread_ratio_optimal.t11_24` | UNMATCHED (as traced) | +0.2205 | +0.2009 | **+0.0196** | [-0.0161, +0.0537] | *no label — not a reading* |
| `cond.within_team_resolution.all` | MATCHED · battle 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.0605 [+0.0599, +0.0613] | +0.0594 | **+0.0012** | [-0.0063, +0.0059] | **WITHIN FLOOR** (|delta| <= floor 0.0056) |
| `cond.within_team_resolution.all` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.0605 [+0.0599, +0.0613] | +0.0595 | **+0.0011** | [-0.0061, +0.0059] | **WITHIN FLOOR** (|delta| <= floor 0.0056) |
| `cond.within_team_resolution.all` | UNMATCHED (as traced) | +0.0606 | +0.0595 | **+0.0012** | [-0.0062, +0.0064] | *no label — not a reading* |
| `cond.within_stratum_resolution.all` | MATCHED · battle 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.0376 [+0.0365, +0.0380] | +0.0303 | **+0.0073** | [+0.0019, +0.0122] | **NOT DETECTED** (CI does not clear the floor 0.0028) |
| `cond.within_stratum_resolution.all` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.0376 [+0.0365, +0.0380] | +0.0305 | **+0.0071** | [+0.0019, +0.0120] | **NOT DETECTED** (CI does not clear the floor 0.0028) |
| `cond.within_stratum_resolution.all` | UNMATCHED (as traced) | +0.0385 | +0.0305 | **+0.0080** | [+0.0024, +0.0131] | *no label — not a reading* |
| `cond.team_spread_ratio_raw.t1_3` | MATCHED · battle 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.3166 [+0.3159, +0.3205] | +0.5735 | **-0.2568** | [-0.2468, -0.1645] | **NOT DETECTED** (CI does not clear the floor 0.2470) |
| `cond.team_spread_ratio_raw.t1_3` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.3166 [+0.3159, +0.3205] | +0.5732 | **-0.2566** | [-0.2469, -0.1632] | **NOT DETECTED** (CI does not clear the floor 0.2470) |
| `cond.team_spread_ratio_raw.t1_3` | UNMATCHED (as traced) | +0.3169 | +0.5732 | **-0.2563** | [-0.2469, -0.1610] | *no label — not a reading* |
| `cond.own_team_r2.late` | MATCHED · battle 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | -0.0023 [-0.0035, -0.0008] | +0.0005 | **-0.0028** | [-0.0103, +0.0044] | **WITHIN FLOOR** (|delta| <= floor 0.0057) |
| `cond.own_team_r2.late` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | -0.0023 [-0.0035, -0.0008] | +0.0028 | **-0.0051** | [-0.0114, +0.0016] | **WITHIN FLOOR** (|delta| <= floor 0.0057) |
| `cond.own_team_r2.late` | UNMATCHED (as traced) | -0.0039 | +0.0028 | **-0.0067** | [-0.0133, +0.0000] | *no label — not a reading* |
| `cond.own_team_r2.t1_minus_late` | MATCHED · battle 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.0382 [+0.0356, +0.0407] | +0.0378 | **+0.0003** | [-0.0158, +0.0176] | **PROVISIONAL — no floor; never DETECTED** (NO FLOOR EXISTS FOR THIS ROW AND THE CONTROLS CANNOT SUPPLY ONE — every control reads own-team R^2 ~= 0 at turn 1, so there is nothing for it to FALL from and the two-draw replicate floor cannot be formed. The first replicate arm supplies it. A LARGE move either way is informative; a small one is not; and this row is never DETECTED) |
| `cond.own_team_r2.t1_minus_late` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +0.0382 [+0.0356, +0.0407] | +0.0348 | **+0.0034** | [-0.0132, +0.0205] | **PROVISIONAL — no floor; never DETECTED** (NO FLOOR EXISTS FOR THIS ROW AND THE CONTROLS CANNOT SUPPLY ONE — every control reads own-team R^2 ~= 0 at turn 1, so there is nothing for it to FALL from and the two-draw replicate floor cannot be formed. The first replicate arm supplies it. A LARGE move either way is informative; a small one is not; and this row is never DETECTED) |
| `cond.own_team_r2.t1_minus_late` | UNMATCHED (as traced) | +0.0408 | +0.0348 | **+0.0060** | [-0.0108, +0.0238] | *no label — not a reading* |
| `cond.calibration_slope.within_stratum` | MATCHED · battle 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +1.3503 [+1.3380, +1.3675] | +1.0097 | **+0.3406** | [+0.2238, +0.4677] | **DETECTED** (vs ZERO — NO FLOOR) |
| `cond.calibration_slope.within_stratum` | MATCHED · decoder 397/188/4 (4783 battles, 4625 decoder battles, 21 seeds) | +1.3503 [+1.3380, +1.3675] | +1.0067 | **+0.3436** | [+0.2326, +0.4665] | **DETECTED** (vs ZERO — NO FLOOR) |
| `cond.calibration_slope.within_stratum` | UNMATCHED (as traced) | +1.3310 | +1.0067 | **+0.3243** | [+0.2086, +0.4377] | *no label — not a reading* |
...
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected · `turn 4-10` | +0.3184 | [+0.2790, +0.3611] | +0.5451 | [+0.4783, +0.6200] |
| between-opponent spread ratio sd(V)/sd(outcome), noise-corrected · `turn 11-24` | +0.6257 | [+0.5489, +0.7080] | +0.7482 | [+0.6573, +0.8546] |
...
| opponent-CLASS (pool vs bot) AUC of V · `turn 1-3` | +0.5592 | [+0.5430, +0.5753] | +0.6005 | [+0.5844, +0.6181] |
| opponent-CLASS (pool vs bot) AUC of V · `turn 4-10` | +0.7179 | [+0.7039, +0.7319] | +0.7169 | [+0.7025, +0.7312] |
| OPPONENT-DECODABLE between-opponent spread ratio — sum_o q(o|V)*p_o, noise-corrected (NOT a bound on the row above) · `turn 1-3` | +0.0121 | [+0.0099, +0.0159] | +0.0268 | [+0.0226, +0.0326] |
| OPPONENT-DECODABLE between-opponent spread ratio — sum_o q(o|V)*p_o, noise-corrected (NOT a bound on the row above) · `turn 4-10` | +0.1310 | [+0.1162, +0.1476] | +0.1354 | [+0.1192, +0.1537] |
| OPPONENT-DECODABLE between-opponent spread ratio — sum_o q(o|V)*p_o, noise-corrected (NOT a bound on the row above) · `turn 11-24` | +0.2205 | [+0.1962, +0.2471] | +0.2009 | [+0.1781, +0.2283] |
| WITHIN-own-team Murphy resolution of V (cells >= MIN_TEAM_BATTLES battles, battle-weighted over teams) · `all states, <=2 per battle` | +0.0606 | [+0.0545, +0.0630] | +0.0595 | [+0.0543, +0.0629] |
| the same resolution WITHIN team-STRENGTH strata (quantiles of the team's LOO win rate) · `all states, <=2 per battle` | +0.0385 | [+0.0352, +0.0428] | +0.0305 | [+0.0277, +0.0347] |
| BETWEEN-team spread ratio sd(mean V) / sd(team win rate), noise-corrected · `turn 1-3` | — | — | +2.0616 | [+0.5026, +0.6841] |
| the same ratio UNCORRECTED and unclamped · `turn 1-3` | +0.3169 | [+0.2210, +0.2623] | +0.5732 | [+0.4093, +0.4831] |
| own-team leave-one-battle-out win-rate R^2 of V · `turn >= 25` | -0.0039 | [-0.0079, -0.0014] | +0.0028 | [-0.0038, +0.0079] |
| own-team R^2 at turn 1 MINUS own-team R^2 late · `turn 1 - turn >= 25` | +0.0408 | [+0.0295, +0.0524] | +0.0348 | [+0.0229, +0.0473] |
| calibration SLOPE — weighted logistic regression of the outcome on logit(V) (1 = correctly dispersed, >1 = SHRUNK, <1 = over-dispersed) · `all states, <=2 per battle` | +1.3798 | [+1.2977, +1.4676] | +1.0719 | [+1.0083, +1.1389] |
| calibration-in-the-large — the INTERCEPT of that regression (0 = calibrated) · `all states, <=2 per battle` | -0.3383 | [-0.4914, -0.1895] | +0.4257 | [+0.3162, +0.5278] |
| calibration SLOPE — weighted logistic regression of the outcome on logit(V) · `turn 1-3, <=2 per battle` | +1.1480 | [+0.9852, +1.3198] | +0.8379 | [+0.7197, +0.9623] |
| calibration-in-the-large — the INTERCEPT of that regression · `turn 1-3, <=2 per battle` | -0.0229 | [-0.3119, +0.2463] | +0.9122 | [+0.7647, +1.0621] |
| calibration SLOPE with a free intercept PER own-team STRENGTH STRATUM — the dispersion reading INSIDE a stratum rather than across teams · `all states, <=2 per battle, stratum fixed effects` | +1.3310 | [+1.2470, +1.4295] | +1.0067 | [+0.9405, +1.0788] |
| calibration SLOPE on the COMMON SUPPORT — both sides restricted to the intersection of their central 95% of V, so the lever arm sd(logit V) cannot differ between them · `all states, <=2 per battle, common V window` | +1.4063 | [+1.3160, +1.5024] | +1.0469 | [+0.9695, +1.1311] |
| calibration-in-the-large on the COMMON SUPPORT · `all states, <=2 per battle, common V window` | -0.3807 | [-0.5312, -0.2299] | +0.4574 | [+0.3320, +0.5802] |
...
```
ai_v12_19_ladder_lambda09 vs ai_v12_11_ladder_ctrl10M at 10M [OFFLINE-GENERATED: 400 games x 9+3 opponents, full capture]: G1 bot Δ +0.0023 [-0.0044, +0.0091] WITHIN FLOOR · identity bias late Δ +0.0124 [-0.0365, +0.0639] WITHIN FLOOR · turn-contrast Δ -0.1246 [-0.2787, +0.0314] NOT DETECTED · spread ratio t1-3 Δ -0.1236 [-0.1607, -0.0895] DETECTED · own-team R2 t1 Δ -0.0027 [-0.0193, +0.0135] WITHIN FLOOR [QUOTA-MATCHED] · calib slope Δ +0.3079 [+0.2037, +0.4159] DETECTED
```
...
python -m main.ops.critic_read ai_v12_19_ladder_lambda09 --control ai_v12_11_ladder_ctrl10M --step 10000032 --arm-traces /home/goodlad/.claude/jobs/9ab51de6/tmp/hp_eval/ai_v12_19_ladder_lambda09 --control-traces /home/goodlad/.claude/jobs/9ab51de6/tmp/hp_eval/ai_v12_11_ladder_ctrl10M --floor-json /home/goodlad/.claude/jobs/9ab51de6/tmp/hp_eval/reads/hp400_floor.json --out /home/goodlad/.claude/jobs/9ab51de6/tmp/hp_eval/reads/ai_v12_19_ladder_lambda09_vs_ctrl10M_v6 --nice 15 --ledger-line
...
| this report | `/home/goodlad/.claude/jobs/9ab51de6/tmp/hp_eval/reads/ai_v12_19_ladder_lambda09_vs_ctrl10M_v6/critic_read.md` |
| machine-readable | `/home/goodlad/.claude/jobs/9ab51de6/tmp/hp_eval/reads/ai_v12_19_ladder_lambda09_vs_ctrl10M_v6/critic_read.json` |
