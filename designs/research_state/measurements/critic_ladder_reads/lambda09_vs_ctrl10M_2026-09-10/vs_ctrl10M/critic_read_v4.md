...
The critic ladder's registered read (ledger 2026-09-08 *REGISTRATION · THE CRITIC LADDER*), produced by `python -m main.ops.critic_read` v4 at 2026-09-10T07:31:37. Every number is a DELTA, **arm − control**, with the difference of the two runs' independent battle-clustered bootstraps. Strength is NOT read.
...
| BETWEEN-team spread ratio sd(mean V) / sd(team win rate), noise-corrected | `turn 1-3` | MATCHED 8/12/2 | +0.1435 | +0.3973 | **-0.2537** | [-0.3344, -0.1062] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
| the same ratio UNCORRECTED and unclamped | `turn 1-3` | MATCHED 8/12/2 | +0.1360 | +0.3573 | **-0.2213** | [-0.2891, -0.1131] | 2000 | **DETECTED** (vs ZERO — NO FLOOR) |
...
| BETWEEN-team spread ratio sd(mean V) / sd(team win rate), noise-corrected · `turn 1-3` | MATCHED 8/12/2 | +0.1435 | +0.3973 | **-0.2537** | [-0.3344, -0.1062] | **DETECTED** (vs ZERO — NO FLOOR) |
| own-team leave-one-battle-out win-rate R^2 of V · `turn 1` | MATCHED 8/12/2 | +0.1735 | -0.0237 | **+0.1971** | [-0.0123, +0.4450] | **NOT DETECTED** (CI covers zero) |
...
| `cond.team_spread_ratio.t1_3` | MATCHED · battle 8/12/2 (230 battles, 79 decoder battles, 21 seeds) | +0.1435 [+0.1057, +0.2268] | +0.3973 | **-0.2537** | [-0.3344, -0.1062] | **DETECTED** (vs ZERO — NO FLOOR) |
| `cond.team_spread_ratio.t1_3` | MATCHED · decoder 8/12/2 (230 battles, 79 decoder battles, 21 seeds) | +0.1435 [+0.1057, +0.2268] | +0.3973 | **-0.2537** | [-0.3344, -0.1062] | **DETECTED** (vs ZERO — NO FLOOR) |
| `cond.team_spread_ratio.t1_3` | UNMATCHED (as traced) | +0.1631 | +0.3973 | **-0.2341** | [-0.3150, -0.0921] | *no label — not a reading* |
| `cond.team_spread_ratio_raw.t1_3` | MATCHED · battle 8/12/2 (230 battles, 79 decoder battles, 21 seeds) | +0.1360 [+0.1045, +0.1919] | +0.3573 | **-0.2213** | [-0.2891, -0.1131] | **DETECTED** (vs ZERO — NO FLOOR) |
| `cond.team_spread_ratio_raw.t1_3` | MATCHED · decoder 8/12/2 (230 battles, 79 decoder battles, 21 seeds) | +0.1360 [+0.1045, +0.1919] | +0.3573 | **-0.2213** | [-0.2891, -0.1131] | **DETECTED** (vs ZERO — NO FLOOR) |
...
python -m main.ops.critic_read ai_v12_19_ladder_lambda09 --control ai_v12_11_ladder_ctrl10M --step 10000032 --floor-json /home/goodlad/.claude/jobs/9ab51de6/tmp/replicate_floor_10M.json --out /home/goodlad/.claude/jobs/9ab51de6/tmp/read_lambda10M_v4_vs_ai_v12_11_ladder_ctrl10M
...
| this report | `/home/goodlad/.claude/jobs/9ab51de6/tmp/read_lambda10M_v4_vs_ai_v12_11_ladder_ctrl10M/critic_read.md` |
| machine-readable | `/home/goodlad/.claude/jobs/9ab51de6/tmp/read_lambda10M_v4_vs_ai_v12_11_ladder_ctrl10M/critic_read.json` |
