#!/bin/bash
# ent05's offline conditioning read (registered 2026-09-12: PASS either direction = the delta CI clears +-0.022 at both draws vs all three controls; else NOT DETECTED). Floors exist for both draws; no control generation needed.
...
PY=/home/goodlad/miniconda3/envs/gen3ai_stable/bin/python3; H=/home/goodlad/.claude/jobs/9ab51de6/tmp/hp_eval; ARM=ai_v12_28_ladder_ent05
