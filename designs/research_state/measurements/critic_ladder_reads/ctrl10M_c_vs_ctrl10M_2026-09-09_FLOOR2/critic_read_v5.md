...
The critic ladder's registered read (ledger 2026-09-08 *REGISTRATION · THE CRITIC LADDER*), produced by `python -m main.ops.critic_read` v5 at 2026-09-10T09:40:23. Every number is a DELTA, **arm − control**, with the difference of the two runs' independent battle-clustered bootstraps. Strength is NOT read.
...
| calibration SLOPE — weighted logistic regression of the outcome on logit(V) (1 = correctly dispersed, >1 = SHRUNK, <1 = over-dispersed) · `all states, <=2 per battle` | as traced | +1.2400 | +1.4412 | **-0.2012** | [-0.5816, +0.1077] | **NOT DETECTED** (CI covers zero) |
...
| calibration SLOPE — weighted logistic regression of the outcome on logit(V) (1 = correctly dispersed, >1 = SHRUNK, <1 = over-dispersed) | `all states, <=2 per battle` | as traced | +1.2400 | +1.4412 | **-0.2012** | [-0.5816, +0.1077] | 2000 | **NOT DETECTED** (CI covers zero) |
| calibration-in-the-large — the INTERCEPT of that regression (0 = calibrated) | `all states, <=2 per battle` | as traced | -0.0602 | +0.0127 | **-0.0729** | [-0.5853, +0.5737] | 2000 | **NOT DETECTED** (CI covers zero) |
| calibration SLOPE — weighted logistic regression of the outcome on logit(V) | `turn 1-3, <=2 per battle` | as traced | +0.9786 | +0.7614 | **+0.2172** | [-0.3409, +0.7232] | 2000 | **NOT DETECTED** (CI covers zero) |
| calibration-in-the-large — the INTERCEPT of that regression | `turn 1-3, <=2 per battle` | as traced | +0.4728 | +1.0014 | **-0.5286** | [-1.2075, +0.2403] | 2000 | **NOT DETECTED** (CI covers zero) |
| calibration SLOPE with a free intercept PER own-team STRENGTH STRATUM — the dispersion reading INSIDE a stratum rather than across teams | `all states, <=2 per battle, stratum fixed effects` | MATCHED 8/12/2 | +1.1370 | +1.5075 | **-0.3705** | [-1.5928, +1.5191] | 2000 | **NOT DETECTED** (CI covers zero) |
| calibration SLOPE on the COMMON SUPPORT — both sides restricted to the intersection of their central 95% of V, so the lever arm sd(logit V) cannot differ between them | `all states, <=2 per battle, common V window` | as traced | +1.1890 | +1.3573 | **-0.1683** | [-0.5958, +0.1740] | 2000 | **NOT DETECTED** (CI covers zero) |
| calibration-in-the-large on the COMMON SUPPORT | `all states, <=2 per battle, common V window` | as traced | +0.0100 | +0.1213 | **-0.1113** | [-0.6790, +0.5922] | 2000 | **NOT DETECTED** (CI covers zero) |
...
|---|---|---|---|---|---|---|---|---|
| arm · all | `all` | 1296 | 648 | 0.8254 | **0.1849** | **1.6208** | [0.274, 0.996] | 0.0000 |
| arm · t1_3 | `t1_3` | 1296 | 648 | 0.7827 | **0.0901** | **0.5742** | [0.590, 0.935] | 0.0000 |
| arm · common support | `common support` | 1208 | 638 | 0.8419 | **0.1435** | **1.3364** | [0.461, 0.993] | 0.0000 |
...
| control · common support | `common support` | 346 | 188 | 0.8403 | **0.1506** | **1.4117** | [0.436, 0.994] | 0.0000 |

The COMMON-SUPPORT window is `V ∈ [0.3080, 0.9959]` — the intersection of the two sides' central 95% of `V`. Both sides are re-fitted inside it, so the lever arm cannot differ between them and a surviving slope difference is not the support.

| row | frame | arm | control | **Δ** | 95% CI | replicate floor | verdict |
|---|---|---|---|---|---|---|---|
| calibration SLOPE · `all states, <=2 per battle` | as traced | +1.2400 | +1.4412 | **-0.2012** | [-0.5816, +0.1077] | — | **NOT DETECTED** (CI covers zero) |
| calibration-in-the-large · `all states, <=2 per battle` | as traced | -0.0602 | +0.0127 | **-0.0729** | [-0.5853, +0.5737] | — | **NOT DETECTED** (CI covers zero) |
| calibration SLOPE · `turn 1-3, <=2 per battle` | as traced | +0.9786 | +0.7614 | **+0.2172** | [-0.3409, +0.7232] | — | **NOT DETECTED** (CI covers zero) |
| calibration-in-the-large · `turn 1-3, <=2 per battle` | as traced | +0.4728 | +1.0014 | **-0.5286** | [-1.2075, +0.2403] | — | **NOT DETECTED** (CI covers zero) |
| calibration SLOPE with a free intercept PER own-team STRENGTH STRATUM · `all states, <=2 per battle, stratum fixed effects` | MATCHED 8/12/2 | +1.1370 | +1.5075 | **-0.3705** | [-1.5928, +1.5191] | — | **NOT DETECTED** (CI covers zero) |
| calibration SLOPE on the COMMON SUPPORT · `all states, <=2 per battle, common V window` | as traced | +1.1890 | +1.3573 | **-0.1683** | [-0.5958, +0.1740] | — | **NOT DETECTED** (CI covers zero) |
| calibration-in-the-large on the COMMON SUPPORT · `all states, <=2 per battle, common V window` | as traced | +0.0100 | +0.1213 | **-0.1113** | [-0.6790, +0.5922] | — | **NOT DETECTED** (CI covers zero) |
...
| `cond.calibration_slope.within_stratum` | MATCHED · battle 8/12/2 (208 battles, 67 decoder battles, 21 seeds) | +1.1370 [+0.4829, +1.7536] | +1.5075 | **-0.3705** | [-1.5928, +1.5191] | **NOT DETECTED** (CI covers zero) |
| `cond.calibration_slope.within_stratum` | MATCHED · decoder 10/15/2 (243 battles, 100 decoder battles, 21 seeds) | +1.2753 [+0.9259, +1.8483] | +1.5075 | **-0.2323** | [-1.3998, +0.4517] | **NOT DETECTED** (CI covers zero) |
| `cond.calibration_slope.within_stratum` | UNMATCHED (as traced) | +1.0707 | +1.5075 | **-0.4369** | [-1.5703, -0.0250] | *no label — not a reading* |
...
| calibration SLOPE — weighted logistic regression of the outcome on logit(V) (1 = correctly dispersed, >1 = SHRUNK, <1 = over-dispersed) · `all states, <=2 per battle` | +1.2400 | [+1.0818, +1.4276] | +1.4412 | [+1.1870, +1.7946] |
| calibration-in-the-large — the INTERCEPT of that regression (0 = calibrated) · `all states, <=2 per battle` | -0.0602 | [-0.3440, +0.2153] | +0.0127 | [-0.5732, +0.4663] |
| calibration SLOPE — weighted logistic regression of the outcome on logit(V) · `turn 1-3, <=2 per battle` | +0.9786 | [+0.6843, +1.2969] | +0.7614 | [+0.3759, +1.2507] |
| calibration-in-the-large — the INTERCEPT of that regression · `turn 1-3, <=2 per battle` | +0.4728 | [+0.0586, +0.8777] | +1.0014 | [+0.3395, +1.5465] |
| calibration SLOPE with a free intercept PER own-team STRENGTH STRATUM — the dispersion reading INSIDE a stratum rather than across teams · `all states, <=2 per battle, stratum fixed effects` | +1.0707 | [+0.8841, +1.3086] | +1.5075 | [+1.1775, +2.6126] |
| calibration SLOPE on the COMMON SUPPORT — both sides restricted to the intersection of their central 95% of V, so the lever arm sd(logit V) cannot differ between them · `all states, <=2 per battle, common V window` | +1.1890 | [+1.0122, +1.3819] | +1.3573 | [+1.0694, +1.7319] |
| calibration-in-the-large on the COMMON SUPPORT · `all states, <=2 per battle, common V window` | +0.0100 | [-0.3031, +0.3132] | +0.1213 | [-0.5032, +0.6315] |
...
python -m main.ops.critic_read ai_v12_16_ladder_ctrl10M_c --control ai_v12_11_ladder_ctrl10M --step 10000032 --out /home/goodlad/.claude/jobs/9ab51de6/tmp/read_floor_c_v5
...
| this report | `/home/goodlad/.claude/jobs/9ab51de6/tmp/read_floor_c_v5/critic_read.md` |
| machine-readable | `/home/goodlad/.claude/jobs/9ab51de6/tmp/read_floor_c_v5/critic_read.json` |
