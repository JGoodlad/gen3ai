---
name: ship
description: Commit all current changes and push to main (both remote and local). Use this skill whenever the user says /ship, "commit and push", "ship it", "get this on main", or any variation of wanting to commit their work and sync it to main. Takes an optional commit message as an argument — if not provided, ask the user for one. Always handles the rebase-before-push flow automatically.
---
