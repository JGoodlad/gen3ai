...
POKEMON_HP_OFFSET = 59          # 23 + 36
POKEMON_SPECIES_KNOWN_OFFSET = 60  # 59 + 1 (HP); 1.0 when slot is populated, 0.0 when absent
POKEMON_COUNTER_OFFSET = 61    # 60 + 1 (species_known): sleep_ctr, toxic_ctr
...
POKEMON_SPREAD_OFFSET = 63     # 61 + 2 (status counters)
...
POKEMON_HP_BLOCK_OFFSET = 81   # 63 + 18 (spread end)
POKEMON_HP_REVEALED_OFFSET = 81
POKEMON_HP_PROBS_OFFSET = 82
POKEMON_HP_BLOCK_DIM = 17      # 1 hp_revealed flag + 16 candidate-type probs
POKEMON_VECTOR_DIM = 98        # 63 + 18 (spread) + 17 (HP block)
POKEMON_FULL_DIM = 99          # 98 + 1 (active flag appended by state_encoder)
