...
class _LightMon:
    ...
    def __init__(self, species: Optional[str], status: "Optional[_LightStatus]",
        ...
        # (A per-mon BOOST ledger used to ride here, reproducing poke-env's keep-the-stages-at-a-
        # faint for the D10 board. The fork now clears them at the faint, as the sim does —
        # `gen3_pe_reading_fixes_v1`, PE-V10 — so the payload's stages are the answer and the
        # ledger is gone.)
