...
"Charge" in a test name means the window ADVANCES the clock (`n` increments). The clock's reward
half — the `last_penalty` the no-progress tax charged — was deleted with the shaped reward path
(2026-09-26), so these tests pin `n`, the `turns_since_progress` obs scalar, alone.
"""
import unittest
