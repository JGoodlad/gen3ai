...
REGISTRY: Tuple[ModelFlag, ...] = (
    ...
    ModelFlag("value_active_readout", False, Tier.CONFIG_ONLY, Klass.STRUCTURAL, 10,
              "route our active mon's refined token into the VALUE projection",
              note="DEMOTED (config_only), frozen OFF: superseded by the MultiSeedValueReadout "
                   "(v61) and --value-threat-inject (v64); never enabled in a gen-8/9/10 run."),
    ...
    ModelFlag("damage_matrices_outgoing_all", False, Tier.CONFIG_ONLY, Klass.STRUCTURAL, 39,
              "the TRANSPOSED outgoing matrix — our 6 mons' 4 moves -> the opp ACTIVE",
              note="DEMOTED (config_only), frozen OFF: never enabled in a gen-8/9/10 run; the "
                   "switch-in offense read it prices is delivered by the d2 edge family."),
    ...
    ModelFlag("pubval_mode", "none", Tier.CLI, Klass.STRUCTURAL, 43,
              "PUBLIC-information value aux head regressed toward the frozen V_pub logistic"),
