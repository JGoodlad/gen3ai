...
#
# The top entry is queued for decomposition (the training entry point), which is why it is worth
# saying out loud that taking an entry off this list is welcome piecemeal work: it needs no
# permission, no design doc and no coordination, and every removal is a permanent reduction in
# how much a reader has to hold at once.
# ---------------------------------------------------------------------------------------------
GRANDFATHERED_SOURCE: Dict[str, int] = {
    "src/main/train_rl_agent.py": 4574,
